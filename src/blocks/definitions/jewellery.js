export const jewelleryBlocks = [
  ...
  <div class="position-absolute top-0 start-0 w-100 h-100" style="background:rgba(10,10,10,0.62);"></div>
  <div class="container position-relative py-5">
    ...
    <p class="mb-5 mx-auto" style="max-width:520px;color:rgba(255,255,255,0.65);font-size:1.05rem;line-height:1.8;font-family:'Jost',sans-serif;">Each piece from Maison Aurel is conceived in our Paris atelier and set by hand — a testament to five generations of savoir-faire.</p>
    ...
    <div class="row g-0 align-items-stretch" style="min-height:88vh;">
      <div class="col-lg-6 d-flex align-items-center justify-content-center order-2 order-lg-1 px-5 py-5" style="background:var(--bs-body-bg);">
        <div style="max-width:480px;">
          ...
          <p class="mb-5" style="color:rgba(255,255,255,0.55);line-height:1.9;font-family:'Jost',sans-serif;">A radiant-cut diamond of exceptional clarity, cradled in 18-carat white gold. The Soleil is an heirloom made for this moment.</p>
          <div class="d-flex gap-3 flex-wrap align-items-center">
            ...
            <a href="#" class="text-white-50" style="font-size:0.82rem;letter-spacing:0.1em;text-transform:uppercase;text-decoration:none;border-bottom:1px solid rgba(255,255,255,0.3);padding-bottom:2px;">Book a Viewing &rarr;</a>
          </div>
          <p class="mt-4" style="color:rgba(201,169,110,0.7);font-size:0.78rem;letter-spacing:0.08em;">From £4,800 · Complimentary engraving</p>
        </div>
      </div>
      <div class="col-lg-6 order-1 order-lg-2" style="min-height:55vw;max-height:92vh;">
        <img src="https://images.unsplash.com/photo-1515562141155-7a31e9680ef7?w=800&q=80" alt="Diamond ring closeup" style="width:100%;height:100%;object-fit:cover;display:block;">
      </div>
    </div>
  </div>
</section>`
  ...
  <div class="container">
    <div class="row g-5 align-items-center">
      <div class="col-lg-5">
        <img src="https://images.unsplash.com/photo-1567225557594-88887a55d097?w=800&q=80" alt="Jewellery craft" style="width:100%;aspect-ratio:4/5;object-fit:cover;display:block;">
      </div>
      <div class="col-lg-6 offset-lg-1">
        ...
        <p style="color:rgba(255,255,255,0.55);line-height:1.9;margin-bottom:2rem;font-family:'Jost',sans-serif;">In our Lyon atelier, a team of twelve master jewellers — each with over two decades of experience — brings each design from sketch to reality using both ancestral techniques and modern CAD precision.</p>
        <div class="row g-4">
          <div class="col-6">
            <p class="text-primary fw-light mb-1" style="font-size:2rem;letter-spacing:0.02em;">142+</p>
            <p style="color:rgba(255,255,255,0.45);font-size:0.82rem;letter-spacing:0.1em;text-transform:uppercase;font-family:'Jost',sans-serif;">Years of Heritage</p>
          </div>
          <div class="col-6">
            <p class="text-primary fw-light mb-1" style="font-size:2rem;letter-spacing:0.02em;">12k+</p>
            <p style="color:rgba(255,255,255,0.45);font-size:0.82rem;letter-spacing:0.1em;text-transform:uppercase;font-family:'Jost',sans-serif;">Pieces Created</p>
          </div>
          <div class="col-6">
            <p class="text-primary fw-light mb-1" style="font-size:2rem;letter-spacing:0.02em;">40h</p>
            <p style="color:rgba(255,255,255,0.45);font-size:0.82rem;letter-spacing:0.1em;text-transform:uppercase;font-family:'Jost',sans-serif;">Avg. Craft Hours</p>
          </div>
          <div class="col-6">
            <p class="text-primary fw-light mb-1" style="font-size:2rem;letter-spacing:0.02em;">18k</p>
            <p style="color:rgba(255,255,255,0.45);font-size:0.82rem;letter-spacing:0.1em;text-transform:uppercase;font-family:'Jost',sans-serif;">Gold Standard</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row g-5 align-items-center mb-6" style="margin-bottom:5rem;">
      <div class="col-lg-6">
        <img src="https://images.unsplash.com/photo-1602751584552-8ba47a5b4024?w=800&q=80" alt="Gold necklace" style="width:100%;aspect-ratio:16/9;object-fit:cover;display:block;">
      </div>
      <div class="col-lg-5 offset-lg-1">
        ...
        <p style="color:rgba(255,255,255,0.5);line-height:1.9;font-family:'Jost',sans-serif;">Each link of the Lumière is cast individually and finished by hand, achieving a liquid quality that catches light with every movement. Available in 18k yellow, rose and white gold.</p>
    ...
    <div class="row g-5 align-items-center">
      <div class="col-lg-5 order-2 order-lg-1">
        ...
        <p style="color:rgba(255,255,255,0.5);line-height:1.9;font-family:'Jost',sans-serif;">The Éclat collection distills the essence of modern luxury into a single diamond drop — a study in restraint that lets the stone speak entirely for itself.</p>
      ...
      <div class="col-lg-6 offset-lg-1 order-1 order-lg-2">
        <img src="https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=800&q=80" alt="Earrings editorial" style="width:100%;aspect-ratio:16/9;object-fit:cover;display:block;">
      </div>
    </div>
  </div>
</section>`
      ...
      <div class="col-md-4">
        <div class="card h-100" style="background:#111;border:none;border-top:1px solid var(--bs-primary);">
          ...
          <div class="card-body p-4">
            ...
            <p style="color:rgba(255,255,255,0.45);font-size:0.88rem;line-height:1.8;font-family:'Jost',sans-serif;">Diamond solitaires of supreme clarity, for moments that define a lifetime.</p>
      ...
      <div class="col-md-4">
        <div class="card h-100" style="background:#111;border:none;border-top:1px solid var(--bs-primary);">
          ...
          <div class="card-body p-4">
            ...
            <p style="color:rgba(255,255,255,0.45);font-size:0.88rem;line-height:1.8;font-family:'Jost',sans-serif;">18-carat gold necklaces that move like water and shine like morning light.</p>
            <a href="#" class="text-primary mt-3 d-block" style="font-size:0.78rem;letter-spacing:0.12em;text-transform:uppercase;text-decoration:none;">Explore &rarr;</a>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card h-100" style="background:#111;border:none;border-top:1px solid var(--bs-primary);">
          ...
          <div class="card-body p-4">
            ...
            <p style="color:rgba(255,255,255,0.45);font-size:0.88rem;line-height:1.8;font-family:'Jost',sans-serif;">A study in restraint — each piece conceived so the diamond speaks on its own terms.</p>
            <a href="#" class="text-primary mt-3 d-block" style="font-size:0.78rem;letter-spacing:0.12em;text-transform:uppercase;text-decoration:none;">Explore &rarr;</a>
          </div>
        </div>
      </div>
  ...
  },
  {
    ...
    html: `<section style="background:#0f0d0b;padding:5rem 0;">
  <div class="container">
    <div class="text-center mb-5">
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card text-center h-100 py-4" style="background:var(--bs-dark);border:1px solid rgba(201,169,110,0.15);border-radius:0;">
          <div class="card-body">
            ...
            <p style="color:rgba(255,255,255,0.4);font-size:0.82rem;line-height:1.8;font-family:'Jost',sans-serif;">D–F colour, VVS clarity. The apex of brilliance.</p>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-lg-3">
        <div class="card text-center h-100 py-4" style="background:var(--bs-dark);border:1px solid rgba(201,169,110,0.15);border-radius:0;">
          <div class="card-body">
            ...
            <p style="color:rgba(255,255,255,0.4);font-size:0.82rem;line-height:1.8;font-family:'Jost',sans-serif;">Kashmir origin. Royal blue of incomparable depth.</p>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-lg-3">
        <div class="card text-center h-100 py-4" style="background:var(--bs-dark);border:1px solid rgba(201,169,110,0.15);border-radius:0;">
          <div class="card-body">
            ...
            <p style="color:rgba(255,255,255,0.4);font-size:0.82rem;line-height:1.8;font-family:'Jost',sans-serif;">Burmese pigeon blood. Passion distilled into stone.</p>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-lg-3">
        <div class="card text-center h-100 py-4" style="background:var(--bs-dark);border:1px solid rgba(201,169,110,0.15);border-radius:0;">
          <div class="card-body">
            ...
            <p style="color:rgba(255,255,255,0.4);font-size:0.82rem;line-height:1.8;font-family:'Jost',sans-serif;">Colombian origin. Nature's most vivid treasure.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card h-100 p-4" style="background:#111;border:none;border-top:1px solid var(--bs-primary);">
          <div class="card-body">
            ...
            <div class="d-flex align-items-center mt-4 gap-3">
              <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&q=80" alt="Isabelle M." style="width:44px;height:44px;border-radius:50%;object-fit:cover;border:1px solid rgba(201,169,110,0.4);">
              <div>
                <p class="text-white mb-0" style="font-size:0.85rem;letter-spacing:0.06em;">Isabelle M.</p>
                <p style="color:rgba(255,255,255,0.35);font-size:0.75rem;margin-bottom:0;font-family:'Jost',sans-serif;">Paris, France</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="card h-100 p-4" style="background:#111;border:none;border-top:1px solid var(--bs-primary);">
          <div class="card-body">
            ...
            <div class="d-flex align-items-center mt-4 gap-3">
              <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80" alt="Thomas W." style="width:44px;height:44px;border-radius:50%;object-fit:cover;border:1px solid rgba(201,169,110,0.4);">
              <div>
                <p class="text-white mb-0" style="font-size:0.85rem;letter-spacing:0.06em;">Thomas W.</p>
                <p style="color:rgba(255,255,255,0.35);font-size:0.75rem;margin-bottom:0;font-family:'Jost',sans-serif;">London, UK</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="card h-100 p-4" style="background:#111;border:none;border-top:1px solid var(--bs-primary);">
          <div class="card-body">
            ...
            <div class="d-flex align-items-center mt-4 gap-3">
              <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&q=80" alt="Camille D." style="width:44px;height:44px;border-radius:50%;object-fit:cover;border:1px solid rgba(201,169,110,0.4);">
              <div>
                <p class="text-white mb-0" style="font-size:0.85rem;letter-spacing:0.06em;">Camille D.</p>
                <p style="color:rgba(255,255,255,0.35);font-size:0.75rem;margin-bottom:0;font-family:'Jost',sans-serif;">Geneva, Switzerland</p>
              </div>
            </div>
          </div>
        </div>
  ...
  },
  {
    ...
    html: `<section style="background:#0f0d0b;padding:6rem 0;">
  <div class="container">
    <div class="row justify-content-center">
  ...
  <div class="container position-relative">
    ...
    <p class="mb-5 mx-auto" style="color:rgba(255,255,255,0.5);max-width:520px;line-height:1.9;font-family:'Jost',sans-serif;">Meet our creative director in our Paris or London atelier. Bring your inspiration, your story, your vision — we will bring it to life in precious metal and stone.</p>
    <div class="d-flex gap-3 justify-content-center flex-wrap">
  ...
  <div class="container">
    <div class="row align-items-center g-4">
      ...
      <div class="col-lg-6 offset-lg-1">
        <p style="color:rgba(255,255,255,0.45);font-family:'Jost',sans-serif;font-size:0.92rem;line-height:1.8;margin-bottom:1.5rem;">Join our private list for early previews, exclusive invitations to trunk shows, and stories from the atelier — delivered with discernment.</p>
        <form class="d-flex gap-2 flex-wrap">
          <input type="email" class="form-control flex-grow-1" placeholder="Your email address" style="background:rgba(255,255,255,0.06);border:1px solid rgba(201,169,110,0.3);color:#fff;border-radius:0;font-family:'Jost',sans-serif;font-size:0.88rem;" aria-label="Email address">
        ...
        <p style="color:rgba(255,255,255,0.25);font-size:0.75rem;margin-top:0.75rem;font-family:'Jost',sans-serif;">We respect your privacy. Unsubscribe at any time.</p>
      </div>
    </div>
  </div>
</section>`
        ...
        <form style="font-family:'Jost',sans-serif;">
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" placeholder="Isabelle" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.12);color:#fff;border-radius:0;font-size:0.9rem;">
            </div>
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" placeholder="Morel" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.12);color:#fff;border-radius:0;font-size:0.9rem;">
            </div>
            <div class="col-sm-6">
              <label class="form-label text-white-50" style="font-size:0.75rem;letter-spacing:0.12em;text-transform:uppercase;">Email</label>
              <input type="email" class="form-control" placeholder="isabelle@example.com" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.12);color:#fff;border-radius:0;font-size:0.9rem;">
            </div>
            <div class="col-sm-6">
              ...
              <select class="form-select" style="background:#151515;border:1px solid rgba(255,255,255,0.12);color:rgba(255,255,255,0.6);border-radius:0;font-size:0.9rem;">
            ...
            <div class="col-12">
              ...
              <textarea class="form-control" rows="4" placeholder="Tell us about the piece you have in mind — the occasion, the recipient, the feeling you wish to evoke…" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.12);color:#fff;border-radius:0;font-size:0.9rem;resize:none;"></textarea>
            </div>
  ...
  <div class="container">
    <div class="row g-5 align-items-start">
      <div class="col-lg-5">
        ...
        <p style="color:rgba(255,255,255,0.45);line-height:1.9;font-family:'Jost',sans-serif;margin-bottom:2rem;">Whether you seek a bespoke commission, wish to learn more about a specific piece, or simply want to visit our atelier, our team is at your service.</p>
        <div class="mb-3">
          <p class="text-primary mb-1" style="font-size:0.72rem;letter-spacing:0.2em;text-transform:uppercase;">Paris</p>
          <p style="color:rgba(255,255,255,0.5);font-size:0.88rem;font-family:'Jost',sans-serif;margin:0;">12 Place Vendôme, 75001 Paris<br>+33 1 42 60 00 00</p>
        </div>
        <div>
          <p class="text-primary mb-1" style="font-size:0.72rem;letter-spacing:0.2em;text-transform:uppercase;">London</p>
          <p style="color:rgba(255,255,255,0.5);font-size:0.88rem;font-family:'Jost',sans-serif;margin:0;">8 Carlos Place, Mayfair, W1K 2AL<br>+44 20 7629 0000</p>
        </div>
      </div>
      <div class="col-lg-6 offset-lg-1">
        <form style="font-family:'Jost',sans-serif;">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);color:#fff;border-radius:0;font-size:0.9rem;">
          </div>
          <div class="mb-3">
            ...
            <input type="email" class="form-control" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);color:#fff;border-radius:0;font-size:0.9rem;">
          </div>
          <div class="mb-3">
            ...
            <select class="form-select" style="background:#151515;border:1px solid rgba(255,255,255,0.1);color:rgba(255,255,255,0.6);border-radius:0;font-size:0.9rem;">
          ...
          <div class="mb-4">
            ...
            <textarea class="form-control" rows="5" style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);color:#fff;border-radius:0;font-size:0.9rem;resize:none;"></textarea>
          </div>
  ...
  <div class="container">
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-md-4">
        <div class="card h-100 p-4" style="background:#111;border:1px solid rgba(201,169,110,0.15);border-radius:0;">
          <div class="card-body">
            ...
            <p style="color:rgba(255,255,255,0.35);font-size:0.8rem;margin-bottom:1.5rem;font-family:'Jost',sans-serif;">Select from our core designs with personalised engraving and metal choice.</p>
            <ul class="list-unstyled mb-4" style="font-family:'Jost',sans-serif;">
              <li class="mb-2 d-flex gap-2" style="color:rgba(255,255,255,0.55);font-size:0.88rem;"><span class="text-primary">—</span> Choice of 18k gold alloy</li>
              <li class="mb-2 d-flex gap-2" style="color:rgba(255,255,255,0.55);font-size:0.88rem;"><span class="text-primary">—</span> Complimentary engraving</li>
              <li class="mb-2 d-flex gap-2" style="color:rgba(255,255,255,0.55);font-size:0.88rem;"><span class="text-primary">—</span> Certificate of authenticity</li>
              <li class="mb-2 d-flex gap-2" style="color:rgba(255,255,255,0.55);font-size:0.88rem;"><span class="text-primary">—</span> 6-week delivery</li>
            </ul>
      ...
      <div class="col-md-4">
        <div class="card h-100 p-4" style="background:var(--bs-dark);border:1px solid var(--bs-primary);border-radius:0;position:relative;">
          ...
          <div class="card-body pt-4">
            ...
            <p style="color:rgba(255,255,255,0.35);font-size:0.8rem;margin-bottom:1.5rem;font-family:'Jost',sans-serif;">A fully bespoke design process with our studio jewellers.</p>
            <ul class="list-unstyled mb-4" style="font-family:'Jost',sans-serif;">
              <li class="mb-2 d-flex gap-2" style="color:rgba(255,255,255,0.55);font-size:0.88rem;"><span class="text-primary">—</span> Dedicated design consultation</li>
              <li class="mb-2 d-flex gap-2" style="color:rgba(255,255,255,0.55);font-size:0.88rem;"><span class="text-primary">—</span> 3D wax model approval</li>
              <li class="mb-2 d-flex gap-2" style="color:rgba(255,255,255,0.55);font-size:0.88rem;"><span class="text-primary">—</span> GIA-certified stone selection</li>
              <li class="mb-2 d-flex gap-2" style="color:rgba(255,255,255,0.55);font-size:0.88rem;"><span class="text-primary">—</span> Lifetime guarantee</li>
            </ul>
      ...
      <div class="col-md-4">
        <div class="card h-100 p-4" style="background:#111;border:1px solid rgba(201,169,110,0.15);border-radius:0;">
          <div class="card-body">
            ...
            <p style="color:rgba(255,255,255,0.35);font-size:0.8rem;margin-bottom:1.5rem;font-family:'Jost',sans-serif;">An extraordinary one-of-a-kind creation with exceptional stones.</p>
            <ul class="list-unstyled mb-4" style="font-family:'Jost',sans-serif;">
              <li class="mb-2 d-flex gap-2" style="color:rgba(255,255,255,0.55);font-size:0.88rem;"><span class="text-primary">—</span> Private creative director meeting</li>
              <li class="mb-2 d-flex gap-2" style="color:rgba(255,255,255,0.55);font-size:0.88rem;"><span class="text-primary">—</span> Access to rare stone reserves</li>
              <li class="mb-2 d-flex gap-2" style="color:rgba(255,255,255,0.55);font-size:0.88rem;"><span class="text-primary">—</span> International courier delivery</li>
              <li class="mb-2 d-flex gap-2" style="color:rgba(255,255,255,0.55);font-size:0.88rem;"><span class="text-primary">—</span> Private vault storage option</li>
            </ul>
  ...
  <div class="container">
    <div class="text-center mb-5">
      ...
      <p class="mt-3 mx-auto" style="color:rgba(255,255,255,0.4);max-width:520px;font-family:'Jost',sans-serif;font-size:0.92rem;line-height:1.8;">Our care plans ensure your piece remains as magnificent decades from now as the day you received it.</p>
    </div>
    <div class="row g-4 justify-content-center">
      <div class="col-md-5">
        <div class="card p-4 h-100" style="background:#111;border:none;border-left:2px solid rgba(201,169,110,0.4);border-radius:0;">
          <div class="card-body">
            <p class="text-primary mb-2" style="font-size:0.7rem;letter-spacing:0.2em;text-transform:uppercase;">Essential Care</p>
            <p class="text-white fw-light mb-1" style="font-size:1.8rem;">£75 <span style="font-size:0.85rem;color:rgba(255,255,255,0.35);">per year</span></p>
            <p style="color:rgba(255,255,255,0.35);font-size:0.82rem;margin-bottom:1.5rem;font-family:'Jost',sans-serif;">Annual service for everyday fine jewellery.</p>
            <ul class="list-unstyled" style="font-family:'Jost',sans-serif;">
              <li class="mb-2" style="color:rgba(255,255,255,0.5);font-size:0.88rem;"><span class="text-primary me-2">—</span>Annual clean &amp; polish</li>
              <li class="mb-2" style="color:rgba(255,255,255,0.5);font-size:0.88rem;"><span class="text-primary me-2">—</span>Prong &amp; setting inspection</li>
              <li class="mb-2" style="color:rgba(255,255,255,0.5);font-size:0.88rem;"><span class="text-primary me-2">—</span>One complimentary resize</li>
            </ul>
      ...
      <div class="col-md-5">
        <div class="card p-4 h-100" style="background:#111;border:none;border-left:2px solid var(--bs-primary);border-radius:0;">
          <div class="card-body">
            ...
            <p style="color:rgba(255,255,255,0.35);font-size:0.82rem;margin-bottom:1.5rem;font-family:'Jost',sans-serif;">Comprehensive coverage for haute joaillerie pieces.</p>
            <ul class="list-unstyled" style="font-family:'Jost',sans-serif;">
              <li class="mb-2" style="color:rgba(255,255,255,0.5);font-size:0.88rem;"><span class="text-primary me-2">—</span>Bi-annual service visits</li>
              <li class="mb-2" style="color:rgba(255,255,255,0.5);font-size:0.88rem;"><span class="text-primary me-2">—</span>Stone replacement cover</li>
              <li class="mb-2" style="color:rgba(255,255,255,0.5);font-size:0.88rem;"><span class="text-primary me-2">—</span>Unlimited resizes</li>
              <li class="mb-2" style="color:rgba(255,255,255,0.5);font-size:0.88rem;"><span class="text-primary me-2">—</span>Priority atelier access</li>
            </ul>
  ...
  // ── FOOTERS ───────────────────────────────────────────────────────────────
  {
    ...
    html: `<footer style="background:#080808;padding:5rem 0 2.5rem;border-top:1px solid rgba(201,169,110,0.15);">
  <div class="container">
    <div class="row g-5 mb-5">
      <div class="col-lg-4">
        <p class="text-white mb-4" style="letter-spacing:0.3em;font-size:1.05rem;font-weight:300;">MAISON AUREL</p>
        <p style="color:rgba(255,255,255,0.38);font-size:0.88rem;line-height:2;font-family:'Jost',sans-serif;max-width:300px;">Five generations of Parisian jewellery-making. Each piece is an heirloom in the making.</p>
        <div class="d-flex gap-3 mt-4">
          <a href="#" style="color:rgba(255,255,255,0.35);text-decoration:none;font-size:0.75rem;letter-spacing:0.12em;text-transform:uppercase;">Instagram</a>
          <a href="#" style="color:rgba(255,255,255,0.35);text-decoration:none;font-size:0.75rem;letter-spacing:0.12em;text-transform:uppercase;">Pinterest</a>
          <a href="#" style="color:rgba(255,255,255,0.35);text-decoration:none;font-size:0.75rem;letter-spacing:0.12em;text-transform:uppercase;">WeChat</a>
        </div>
      </div>
      <div class="col-sm-4 col-lg-2">
        <p class="text-primary mb-3" style="font-size:0.7rem;letter-spacing:0.25em;text-transform:uppercase;">Collections</p>
        <ul class="list-unstyled" style="font-family:'Jost',sans-serif;">
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">Rings</a></li>
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">Necklaces</a></li>
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">Earrings</a></li>
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">Bracelets</a></li>
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">Watches</a></li>
        </ul>
      </div>
      <div class="col-sm-4 col-lg-2">
        <p class="text-primary mb-3" style="font-size:0.7rem;letter-spacing:0.25em;text-transform:uppercase;">Maison</p>
        <ul class="list-unstyled" style="font-family:'Jost',sans-serif;">
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">Our Heritage</a></li>
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">The Atelier</a></li>
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">Bespoke</a></li>
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">Careers</a></li>
        </ul>
      </div>
      <div class="col-sm-4 col-lg-2">
        <p class="text-primary mb-3" style="font-size:0.7rem;letter-spacing:0.25em;text-transform:uppercase;">Client Services</p>
        <ul class="list-unstyled" style="font-family:'Jost',sans-serif;">
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">Contact Us</a></li>
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">Shipping</a></li>
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">Returns</a></li>
          <li class="mb-2"><a href="#" style="color:rgba(255,255,255,0.4);text-decoration:none;font-size:0.88rem;">Care Plans</a></li>
        </ul>
      </div>
      <div class="col-lg-2">
        <p class="text-primary mb-3" style="font-size:0.7rem;letter-spacing:0.25em;text-transform:uppercase;">Ateliers</p>
        <p style="color:rgba(255,255,255,0.38);font-size:0.82rem;line-height:1.8;font-family:'Jost',sans-serif;">Paris · London<br>Geneva · Tokyo</p>
      </div>
    </div>
    <div style="border-top:1px solid rgba(255,255,255,0.07);padding-top:1.5rem;" class="d-flex flex-wrap justify-content-between align-items-center gap-2">
      <p style="color:rgba(255,255,255,0.22);font-size:0.75rem;margin:0;font-family:'Jost',sans-serif;">© 2026 Maison Aurel. All rights reserved.</p>
      <div class="d-flex gap-4">
        <a href="#" style="color:rgba(255,255,255,0.22);text-decoration:none;font-size:0.72rem;letter-spacing:0.08em;font-family:'Jost',sans-serif;">Privacy</a>
        <a href="#" style="color:rgba(255,255,255,0.22);text-decoration:none;font-size:0.72rem;letter-spacing:0.08em;font-family:'Jost',sans-serif;">Legal</a>
        <a href="#" style="color:rgba(255,255,255,0.22);text-decoration:none;font-size:0.72rem;letter-spacing:0.08em;font-family:'Jost',sans-serif;">Cookies</a>
      </div>
    </div>
  </div>
</footer>`
  ...
  <div class="container">
    ...
    <nav class="d-flex flex-wrap justify-content-center gap-4 mb-4">
      <a href="#" style="color:rgba(255,255,255,0.35);text-decoration:none;font-size:0.72rem;letter-spacing:0.18em;text-transform:uppercase;font-family:'Jost',sans-serif;">Collections</a>
      <a href="#" style="color:rgba(255,255,255,0.35);text-decoration:none;font-size:0.72rem;letter-spacing:0.18em;text-transform:uppercase;font-family:'Jost',sans-serif;">Bespoke</a>
      <a href="#" style="color:rgba(255,255,255,0.35);text-decoration:none;font-size:0.72rem;letter-spacing:0.18em;text-transform:uppercase;font-family:'Jost',sans-serif;">Heritage</a>
      <a href="#" style="color:rgba(255,255,255,0.35);text-decoration:none;font-size:0.72rem;letter-spacing:0.18em;text-transform:uppercase;font-family:'Jost',sans-serif;">Ateliers</a>
      <a href="#" style="color:rgba(255,255,255,0.35);text-decoration:none;font-size:0.72rem;letter-spacing:0.18em;text-transform:uppercase;font-family:'Jost',sans-serif;">Contact</a>
    </nav>
    <p class="text-center" style="color:rgba(255,255,255,0.18);font-size:0.72rem;margin:0;font-family:'Jost',sans-serif;">© 2026 Maison Aurel. Jewellers by Royal Appointment.</p>
  </div>
</footer>`
  },
  ...
  <div class="container">
    ...
    <div class="row g-3">
      <div class="col-md-6 col-lg-4">
        <img src="https://images.unsplash.com/photo-1515562141155-7a31e9680ef7?w=800&q=80" alt="Diamond ring" style="width:100%;height:280px;object-fit:cover;display:block;">
      </div>
      <div class="col-md-6 col-lg-4">
        <img src="https://images.unsplash.com/photo-1602751584552-8ba47a5b4024?w=800&q=80" alt="Gold necklace" style="width:100%;height:280px;object-fit:cover;display:block;">
      </div>
      <div class="col-md-6 col-lg-4">
        <img src="https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=800&q=80" alt="Earrings" style="width:100%;height:280px;object-fit:cover;display:block;">
      </div>
      <div class="col-md-6 col-lg-3">
        <img src="https://images.unsplash.com/photo-1586105449897-20b5efeb3233?w=800&q=80" alt="Sapphire ring" style="width:100%;height:220px;object-fit:cover;display:block;">
      </div>
      <div class="col-md-6 col-lg-3">
        <img src="https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=800&q=80" alt="Diamond solitaire" style="width:100%;height:220px;object-fit:cover;display:block;">
      </div>
      <div class="col-md-6 col-lg-3">
        <img src="https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&q=80" alt="Gold chain" style="width:100%;height:220px;object-fit:cover;display:block;">
      </div>
      <div class="col-md-6 col-lg-3">
        <img src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=800&q=80" alt="Luxury watch" style="width:100%;height:220px;object-fit:cover;display:block;">
      </div>
    </div>
    ...
    <div class="row g-1">
      <div class="col-6 col-lg-3">
        <div class="position-relative overflow-hidden" style="aspect-ratio:3/4;">
          <img src="https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&q=80" alt="Collection dark" style="width:100%;height:100%;object-fit:cover;display:block;transition:transform 0.6s;">
          <div class="position-absolute bottom-0 start-0 w-100 p-3" style="background:linear-gradient(0deg,rgba(0,0,0,0.7),transparent);">
            <p class="text-white mb-0" style="font-size:0.75rem;letter-spacing:0.12em;text-transform:uppercase;font-family:'Jost',sans-serif;">Noir Solitaire</p>
          </div>
        </div>
      </div>
      <div class="col-6 col-lg-3">
        <div class="position-relative overflow-hidden" style="aspect-ratio:3/4;">
          <img src="https://images.unsplash.com/photo-1586105449897-20b5efeb3233?w=800&q=80" alt="Sapphire ring" style="width:100%;height:100%;object-fit:cover;display:block;">
          <div class="position-absolute bottom-0 start-0 w-100 p-3" style="background:linear-gradient(0deg,rgba(0,0,0,0.7),transparent);">
            <p class="text-white mb-0" style="font-size:0.75rem;letter-spacing:0.12em;text-transform:uppercase;font-family:'Jost',sans-serif;">Kashmir Blue</p>
          </div>
        </div>
      </div>
      <div class="col-6 col-lg-3">
        <div class="position-relative overflow-hidden" style="aspect-ratio:3/4;">
          <img src="https://images.unsplash.com/photo-1567225557594-88887a55d097?w=800&q=80" alt="Craft" style="width:100%;height:100%;object-fit:cover;display:block;">
          <div class="position-absolute bottom-0 start-0 w-100 p-3" style="background:linear-gradient(0deg,rgba(0,0,0,0.7),transparent);">
            <p class="text-white mb-0" style="font-size:0.75rem;letter-spacing:0.12em;text-transform:uppercase;font-family:'Jost',sans-serif;">Atelier Series</p>
          </div>
        </div>
      </div>
      <div class="col-6 col-lg-3">
        <div class="position-relative overflow-hidden" style="aspect-ratio:3/4;">
          <img src="https://images.unsplash.com/photo-1458153989938-ba4b959e9d2c?w=800&q=80" alt="Jewellery store" style="width:100%;height:100%;object-fit:cover;display:block;">
          <div class="position-absolute bottom-0 start-0 w-100 p-3" style="background:linear-gradient(0deg,rgba(0,0,0,0.7),transparent);">
            <p class="text-white mb-0" style="font-size:0.75rem;letter-spacing:0.12em;text-transform:uppercase;font-family:'Jost',sans-serif;">The Maison</p>
          </div>
        </div>
      </div>
    </div>
  ...
  // ── SOCIAL PROOF ──────────────────────────────────────────────────────────
  {
    ...
    html: `<section style="background:#0f0d0b;padding:3.5rem 0;border-top:1px solid rgba(201,169,110,0.1);border-bottom:1px solid rgba(201,169,110,0.1);">
  <div class="container">
    <p class="text-center mb-4" style="color:rgba(255,255,255,0.25);font-size:0.72rem;letter-spacing:0.28em;text-transform:uppercase;font-family:'Jost',sans-serif;">As Featured In</p>
  ...
  <div class="container">
    ...
    <div class="row g-4 justify-content-center text-center">
      <div class="col-sm-6 col-lg-3">
        <div style="border:1px solid rgba(201,169,110,0.2);padding:2rem 1.5rem;">
          <p class="text-primary mb-2" style="font-size:1.8rem;font-weight:300;letter-spacing:0.03em;">RJC</p>
          <p style="color:rgba(255,255,255,0.35);font-size:0.78rem;letter-spacing:0.1em;text-transform:uppercase;font-family:'Jost',sans-serif;margin:0;">Certified Member</p>
        </div>
      </div>
      <div class="col-sm-6 col-lg-3">
        <div style="border:1px solid rgba(201,169,110,0.2);padding:2rem 1.5rem;">
          <p class="text-primary mb-2" style="font-size:1.8rem;font-weight:300;letter-spacing:0.03em;">GIA</p>
          <p style="color:rgba(255,255,255,0.35);font-size:0.78rem;letter-spacing:0.1em;text-transform:uppercase;font-family:'Jost',sans-serif;margin:0;">Graduate Gemologists</p>
        </div>
      </div>
      <div class="col-sm-6 col-lg-3">
        <div style="border:1px solid rgba(201,169,110,0.2);padding:2rem 1.5rem;">
          <p class="text-primary mb-2" style="font-size:1.8rem;font-weight:300;letter-spacing:0.03em;">5★</p>
          <p style="color:rgba(255,255,255,0.35);font-size:0.78rem;letter-spacing:0.1em;text-transform:uppercase;font-family:'Jost',sans-serif;margin:0;">Trustpilot Rating</p>
        </div>
      </div>
      <div class="col-sm-6 col-lg-3">
        <div style="border:1px solid rgba(201,169,110,0.2);padding:2rem 1.5rem;">
          <p class="text-primary mb-2" style="font-size:1.8rem;font-weight:300;letter-spacing:0.03em;">VIP</p>
          <p style="color:rgba(255,255,255,0.35);font-size:0.78rem;letter-spacing:0.1em;text-transform:uppercase;font-family:'Jost',sans-serif;margin:0;">By Royal Appointment</p>
        </div>
      </div>
    </div>
    <p class="text-center mt-5" style="color:rgba(255,255,255,0.2);font-size:0.78rem;font-family:'Jost',sans-serif;letter-spacing:0.06em;">Over 12,000 clients across 38 countries trust Maison Aurel</p>
  </div>
</section>`
  },
  ...
  <div class="container">
    ...
    <div class="row g-4">
      <div class="col-md-6 col-lg-3">
        <div style="border-top:1px solid rgba(201,169,110,0.4);padding-top:1.8rem;">
          ...
          <p style="color:rgba(255,255,255,0.42);font-size:0.88rem;line-height:1.9;font-family:'Jost',sans-serif;">A private consultation with our creative director. We listen to your story, your aesthetic, and the feeling you wish to capture.</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-3">
        <div style="border-top:1px solid rgba(201,169,110,0.4);padding-top:1.8rem;">
          ...
          <p style="color:rgba(255,255,255,0.42);font-size:0.88rem;line-height:1.9;font-family:'Jost',sans-serif;">Our atelier produces hand-drawn sketches and 3D renderings, refining the design until it aligns precisely with your vision.</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-3">
        <div style="border-top:1px solid rgba(201,169,110,0.4);padding-top:1.8rem;">
          ...
          <p style="color:rgba(255,255,255,0.42);font-size:0.88rem;line-height:1.9;font-family:'Jost',sans-serif;">Your piece is cast, hand-finished and set by our master jewellers — a process of between four and twelve weeks of dedicated craft.</p>
        </div>
      </div>
      <div class="col-md-6 col-lg-3">
        <div style="border-top:1px solid rgba(201,169,110,0.4);padding-top:1.8rem;">
          ...
          <p style="color:rgba(255,255,255,0.42);font-size:0.88rem;line-height:1.9;font-family:'Jost',sans-serif;">We present your creation in our signature black lacquer box. The beginning of a lifetime's relationship between you and your jewellery.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row g-5 align-items-center">
      <div class="col-lg-5">
        <img src="https://images.unsplash.com/photo-1567225557594-88887a55d097?w=800&q=80" alt="Jewellery making" style="width:100%;aspect-ratio:3/4;object-fit:cover;display:block;">
      </div>
      <div class="col-lg-6 offset-lg-1">
        ...
        <div class="d-flex flex-column gap-4">
          <div class="d-flex gap-4 align-items-start">
            ...
            <div>
              ...
              <p style="color:rgba(255,255,255,0.4);font-size:0.85rem;line-height:1.8;font-family:'Jost',sans-serif;margin:0;">Pencil sketches capture the spirit of the piece before any tool is lifted.</p>
            </div>
          </div>
          <div class="d-flex gap-4 align-items-start">
            ...
            <div>
              ...
              <p style="color:rgba(255,255,255,0.4);font-size:0.85rem;line-height:1.8;font-family:'Jost',sans-serif;margin:0;">A centuries-old technique refined by Maison Aurel over five generations.</p>
            </div>
          </div>
          <div class="d-flex gap-4 align-items-start">
            ...
            <div>
              ...
              <p style="color:rgba(255,255,255,0.4);font-size:0.85rem;line-height:1.8;font-family:'Jost',sans-serif;margin:0;">Each stone is seated individually under magnification, ensuring perfect security and brilliance.</p>
            </div>
          </div>
          <div class="d-flex gap-4 align-items-start">
            ...
            <div>
              ...
              <p style="color:rgba(255,255,255,0.4);font-size:0.85rem;line-height:1.8;font-family:'Jost',sans-serif;margin:0;">Sixty-point inspection by our head gemmologist before any piece leaves the atelier.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="row g-4">
      <div class="col-sm-6 col-lg-3">
        <div style="background:#111;">
          ...
          <div class="p-3">
            ...
            <p class="text-white mb-3" style="font-size:0.92rem;font-family:'Jost',sans-serif;">From £4,800</p>
      ...
      <div class="col-sm-6 col-lg-3">
        <div style="background:#111;">
          <div class="position-relative overflow-hidden" style="aspect-ratio:3/4;">
            <img src="https://images.unsplash.com/photo-1602751584552-8ba47a5b4024?w=800&q=80" alt="Gold Necklace" style="width:100%;height:100%;object-fit:cover;display:block;">
          </div>
          <div class="p-3">
            ...
            <p class="text-white mb-3" style="font-size:0.92rem;font-family:'Jost',sans-serif;">From £2,200</p>
            <a href="#" class="btn btn-primary w-100 py-2" style="border-radius:0;font-size:0.75rem;letter-spacing:0.1em;text-transform:uppercase;">View Piece</a>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-lg-3">
        <div style="background:#111;">
          ...
          <div class="p-3">
            ...
            <p class="text-white mb-3" style="font-size:0.92rem;font-family:'Jost',sans-serif;">From £7,400</p>
            <a href="#" class="btn btn-primary w-100 py-2" style="border-radius:0;font-size:0.75rem;letter-spacing:0.1em;text-transform:uppercase;">View Piece</a>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-lg-3">
        <div style="background:#111;">
          <div class="position-relative overflow-hidden" style="aspect-ratio:3/4;">
            <img src="https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=800&q=80" alt="Earrings" style="width:100%;height:100%;object-fit:cover;display:block;">
          </div>
          <div class="p-3">
            ...
            <p class="text-white mb-3" style="font-size:0.92rem;font-family:'Jost',sans-serif;">From £3,600</p>
            <a href="#" class="btn btn-primary w-100 py-2" style="border-radius:0;font-size:0.75rem;letter-spacing:0.1em;text-transform:uppercase;">View Piece</a>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row g-5 align-items-start">
      <div class="col-lg-6">
        <div class="mb-3">
          <img src="https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=800&q=80" alt="Diamond solitaire main" style="width:100%;aspect-ratio:4/5;object-fit:cover;display:block;">
        </div>
        <div class="row g-2">
          <div class="col-4">
            <img src="https://images.unsplash.com/photo-1515562141155-7a31e9680ef7?w=800&q=80" alt="Ring view 1" style="width:100%;height:80px;object-fit:cover;opacity:0.7;">
          </div>
          <div class="col-4">
            <img src="https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&q=80" alt="Ring view 2" style="width:100%;height:80px;object-fit:cover;opacity:0.7;">
          </div>
          <div class="col-4">
            <img src="https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&q=80" alt="Ring view 3" style="width:100%;height:80px;object-fit:cover;opacity:0.7;">
          </div>
        </div>
      </div>
      <div class="col-lg-6">
        ...
        <div class="mb-4">
          <p style="font-size:0.72rem;letter-spacing:0.18em;text-transform:uppercase;color:rgba(255,255,255,0.4);font-family:'Jost',sans-serif;margin-bottom:0.5rem;">Ring Size</p>
          <select class="form-select" style="background:rgba(255,255,255,0.05);border:1px solid rgba(201,169,110,0.3);color:rgba(255,255,255,0.7);border-radius:0;font-size:0.88rem;max-width:180px;font-family:'Jost',sans-serif;">
        ...
        <div class="d-flex gap-4 flex-wrap" style="border-top:1px solid rgba(255,255,255,0.07);padding-top:1.5rem;">
          <div>
            ...
            <p style="color:rgba(255,255,255,0.4);font-size:0.8rem;margin:0;font-family:'Jost',sans-serif;">4–8 weeks</p>
          </div>
          <div>
            <p class="text-primary mb-0" style="font-size:0.65rem;letter-spacing:0.18em;text-transform:uppercase;">Guarantee</p>
            <p style="color:rgba(255,255,255,0.4);font-size:0.8rem;margin:0;font-family:'Jost',sans-serif;">Lifetime</p>
          </div>
          <div>
            <p class="text-primary mb-0" style="font-size:0.65rem;letter-spacing:0.18em;text-transform:uppercase;">Certificate</p>
            <p style="color:rgba(255,255,255,0.4);font-size:0.8rem;margin:0;font-family:'Jost',sans-serif;">GIA included</p>
          </div>
        </div>
      </div>
    </div>
