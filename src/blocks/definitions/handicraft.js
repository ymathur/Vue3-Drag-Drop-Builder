export const handicraftBlocks = [
  // ─── NAVIGATION ────────────────────────────────────────────────────────────
  {
    ...
    html: `<nav class="navbar navbar-expand-lg navbar-dark" style="background:#2d2f6b;">
  <div class="container">
    <a class="navbar-brand d-flex align-items-center gap-2" href="#">
      <span style="display:inline-block;width:32px;height:32px;background:#f0a500;border-radius:50%;"></span>
  ...
  },
  {
    ...
    html: `<div>
  <div style="background:#f0a500;" class="py-2 text-center">
    <span class="small fw-semibold" style="color:#2d2f6b;">Free shipping on orders above ₹999 &nbsp;|&nbsp; Handcrafted with love, delivered to your door</span>
  </div>
  <nav class="navbar navbar-expand-lg" style="background:#fdf8f0; border-bottom:2px solid #e5d8c0;">
    <div class="container">
      <a class="navbar-brand fw-bold" href="#" style="color:#2d2f6b; font-size:1.3rem; letter-spacing:0.05em;">The Folk Loom</a>
      ...
      <div class="collapse navbar-collapse" id="hcrNav2">
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
          <li class="nav-item"><a class="nav-link fw-semibold" href="#" style="color:#2d2f6b;">Textiles</a></li>
          <li class="nav-item"><a class="nav-link fw-semibold" href="#" style="color:#2d2f6b;">Pottery</a></li>
          <li class="nav-item"><a class="nav-link fw-semibold" href="#" style="color:#2d2f6b;">Block Prints</a></li>
          <li class="nav-item"><a class="nav-link fw-semibold" href="#" style="color:#2d2f6b;">Embroidery</a></li>
          <li class="nav-item"><a class="nav-link fw-semibold" href="#" style="color:#2d2f6b;">Gifting</a></li>
        </ul>
        <div class="d-flex align-items-center gap-3">
          <a href="#" style="color:#2d2f6b;"><i class="bi bi-search fs-5"></i></a>
          <a href="#" style="color:#2d2f6b;"><i class="bi bi-bag fs-5"></i></a>
  ...
  <div class="container position-relative py-5">
    <p class="text-uppercase fw-semibold mb-3" style="letter-spacing:0.15em; color:#f0a500;">Handcrafted with Centuries of Tradition</p>
  ...
  },
  {
    ...
    html: `<section class="py-5" style="background:#fdf8f0;">
  <div class="container py-4">
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">The Folk Loom — Est. 1974</p>
        <h1 class="fw-bold mb-4" style="font-family:'EB Garamond', serif; font-size:3rem; line-height:1.15; color:#2d2f6b;">Crafted by Hand,<br>Shaped by Heritage</h1>
        ...
        <div class="d-flex gap-4 mt-2">
          <div><div class="fw-bold fs-4" style="color:#2d2f6b;">500+</div><div class="small text-muted">Artisan Partners</div></div>
          <div><div class="fw-bold fs-4" style="color:#2d2f6b;">28</div><div class="small text-muted">Craft Traditions</div></div>
          <div><div class="fw-bold fs-4" style="color:#2d2f6b;">15k+</div><div class="small text-muted">Happy Patrons</div></div>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="position-relative">
          ...
          <div class="position-absolute bottom-0 start-0 m-3 px-3 py-2 rounded-2" style="background:#f0a500;">
            <span class="fw-bold" style="color:#2d2f6b; font-size:0.85rem;">100% Natural Dyes &amp; Handmade</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container py-3">
    <div class="text-center mb-5">
      <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">Why Craft House Indira</p>
      <h2 class="fw-bold" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.4rem;">Rooted in Tradition, Made for Today</h2>
    </div>
    <div class="row g-4 text-center">
      <div class="col-md-4">
        <div class="p-4 rounded-3 h-100" style="background:#fdf8f0; border:1.5px solid #e5d8c0;">
          <div class="mb-3" style="font-size:2.5rem;">🪡</div>
          <h5 class="fw-bold mb-2" style="color:#2d2f6b;">Authentic Block Print</h5>
      ...
      <div class="col-md-4">
        <div class="p-4 rounded-3 h-100" style="background:#fdf8f0; border:1.5px solid #e5d8c0;">
          <div class="mb-3" style="font-size:2.5rem;">🌿</div>
          <h5 class="fw-bold mb-2" style="color:#2d2f6b;">Natural Dye Heritage</h5>
      ...
      <div class="col-md-4">
        <div class="p-4 rounded-3 h-100" style="background:#fdf8f0; border:1.5px solid #e5d8c0;">
          <div class="mb-3" style="font-size:2.5rem;">🤝</div>
          <h5 class="fw-bold mb-2" style="color:#2d2f6b;">Fair Artisan Wages</h5>
  ...
  <div class="container py-3">
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-7">
        <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">Our Craft Promise</p>
        <h2 class="fw-bold mb-4" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.2rem;">Where Every Thread Carries Meaning</h2>
        <div class="d-flex flex-column gap-4">
          <div class="d-flex gap-3 align-items-start">
            <div class="flex-shrink-0 rounded-2 d-flex align-items-center justify-content-center" style="width:44px;height:44px;background:#2d2f6b;">
              <span style="color:#f0a500; font-size:1.2rem;">✦</span>
            </div>
            <div>
              <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Handcrafted, Not Mass-Produced</h6>
          ...
          <div class="d-flex gap-3 align-items-start">
            ...
            <div>
              <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Certified Craft Origin</h6>
          ...
          <div class="d-flex gap-3 align-items-start">
            ...
            <div>
              <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Ethically Sourced Materials</h6>
          ...
          <div class="d-flex gap-3 align-items-start">
            ...
            <div>
              <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Gift-Ready Packaging</h6>
  ...
  <div class="container py-3">
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">Our Heritage Story</p>
  ...
  <div class="container py-3">
    <div class="row justify-content-center mb-5">
      <div class="col-lg-7 text-center">
        <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">The Art of Natural Dyeing</p>
        <h2 class="fw-bold mb-3" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.3rem;">Indigo: The Colour of the Cosmos</h2>
    ...
    <div class="row g-4 align-items-start">
      ...
      <div class="col-lg-5">
        <h5 class="fw-bold mb-3" style="color:#2d2f6b;">A Centuries-Old Process</h5>
        ...
        <div class="d-flex flex-column gap-2">
          <div class="d-flex align-items-center gap-2"><span style="color:#f0a500; font-weight:700;">01.</span><span class="text-muted small">Mordanting cotton to accept natural dye</span></div>
          <div class="d-flex align-items-center gap-2"><span style="color:#f0a500; font-weight:700;">02.</span><span class="text-muted small">Preparing the indigo fermentation vat</span></div>
          <div class="d-flex align-items-center gap-2"><span style="color:#f0a500; font-weight:700;">03.</span><span class="text-muted small">Repeated dipping and air oxidation</span></div>
          <div class="d-flex align-items-center gap-2"><span style="color:#f0a500; font-weight:700;">04.</span><span class="text-muted small">Sun drying and finishing by hand</span></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container py-3">
    <div class="text-center mb-5">
      <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">Explore by Craft</p>
      <h2 class="fw-bold" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.3rem;">Traditions Passed Through Generations</h2>
    </div>
    <div class="row g-4">
      <div class="col-sm-6 col-lg-3">
        <div class="card h-100 overflow-hidden" style="border:1.5px solid #e5d8c0;">
          ...
          <div class="card-body">
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Block Printing</h6>
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card h-100 overflow-hidden" style="border:1.5px solid #e5d8c0;">
          ...
          <div class="card-body">
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Handloom Weaving</h6>
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card h-100 overflow-hidden" style="border:1.5px solid #e5d8c0;">
          ...
          <div class="card-body">
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Painted Ceramics</h6>
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card h-100 overflow-hidden" style="border:1.5px solid #e5d8c0;">
          ...
          <div class="card-body">
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Folk Embroidery</h6>
  ...
  <div class="container py-3">
    <div class="text-center mb-5">
      <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">Meet the Makers</p>
      <h2 class="fw-bold" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.3rem;">The Hands Behind the Heritage</h2>
    </div>
    <div class="row g-4 justify-content-center">
      <div class="col-md-4">
        <div class="card text-center" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
          <div class="card-body p-4">
            <img src="https://images.unsplash.com/photo-1578301978018-3005759f48f7?w=800&q=80" alt="Artisan Meera" class="rounded-circle mb-3 shadow" style="width:90px;height:90px;object-fit:cover; border:3px solid #f0a500;">
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Meera Kumari</h6>
            <p class="small mb-2" style="color:#f0a500; font-weight:600;">Block Print Master — Sanganer, Rajasthan</p>
            ...
            <span class="badge" style="background:#2d2f6b; color:#f0a500;">32 years of craft</span>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card text-center" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
          <div class="card-body p-4">
            <img src="https://images.unsplash.com/photo-1492539438225-2666b2a98f93?w=800&q=80" alt="Artisan Rajan" class="rounded-circle mb-3 shadow" style="width:90px;height:90px;object-fit:cover; border:3px solid #f0a500;">
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Rajan Prajapat</h6>
            <p class="small mb-2" style="color:#f0a500; font-weight:600;">Potter — Khurja, Uttar Pradesh</p>
            ...
            <span class="badge" style="background:#2d2f6b; color:#f0a500;">National Award — 2019</span>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card text-center" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
          <div class="card-body p-4">
            <img src="https://images.unsplash.com/photo-1503602642458-232111445657?w=800&q=80" alt="Artisan Fathima" class="rounded-circle mb-3 shadow" style="width:90px;height:90px;object-fit:cover; border:3px solid #f0a500;">
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Fathima Bi</h6>
            <p class="small mb-2" style="color:#f0a500; font-weight:600;">Basket Weaver — Nirmal, Telangana</p>
            ...
            <span class="badge" style="background:#2d2f6b; color:#f0a500;">Community of 40 weavers</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container py-3">
    <div class="text-center mb-5">
      <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">Patron Stories</p>
      <h2 class="fw-bold" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.2rem;">Loved by Those Who Value Craft</h2>
    </div>
    <div class="row g-4">
      <div class="col-md-4">
        <div class="card h-100 p-4" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
          <div class="mb-3" style="color:#f0a500; font-size:1.3rem;">★★★★★</div>
          ...
          <div class="d-flex align-items-center gap-3 mt-auto">
            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&q=80" alt="Ananya S." class="rounded-circle" style="width:46px;height:46px;object-fit:cover; border:2px solid #f0a500;">
            <div>
              <div class="fw-bold small" style="color:#2d2f6b;">Ananya Sharma</div>
      ...
      <div class="col-md-4">
        <div class="card h-100 p-4" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
          ...
          <div class="d-flex align-items-center gap-3 mt-auto">
            <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80" alt="Rohan M." class="rounded-circle" style="width:46px;height:46px;object-fit:cover; border:2px solid #f0a500;">
            <div>
              <div class="fw-bold small" style="color:#2d2f6b;">Rohan Mehta</div>
      ...
      <div class="col-md-4">
        <div class="card h-100 p-4" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
          ...
          <div class="d-flex align-items-center gap-3 mt-auto">
            <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&q=80" alt="Priya K." class="rounded-circle" style="width:46px;height:46px;object-fit:cover; border:2px solid #f0a500;">
            <div>
              <div class="fw-bold small" style="color:#2d2f6b;">Priya Krishnan</div>
  ...
  <div class="container py-4">
    <div class="row justify-content-center">
      <div class="col-lg-8 text-center">
        <div class="mb-4" style="font-size:3rem; color:#f0a500; line-height:1;">"</div>
        ...
        <div class="d-flex align-items-center justify-content-center gap-4">
          <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&q=80" alt="Lakshmi Nair" class="rounded-circle shadow" style="width:64px;height:64px;object-fit:cover; border:3px solid #f0a500;">
          <div class="text-start">
            <div class="fw-bold" style="color:#f0a500;">Lakshmi Nair</div>
  ...
  // ─── CTA ────────────────────────────────────────────────────────────────────
  {
    ...
    html: `<section class="py-5 text-center" style="background:#f0a500;">
  <div class="container py-3">
    <h2 class="fw-bold mb-3" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.5rem;">Take a Piece of Heritage Home</h2>
    <p class="lead mb-4 mx-auto" style="color:#2d2f6b; max-width:580px; opacity:0.85;">Every item in our collection directly supports a family of artisans. Shop handcrafted goods that carry the soul of centuries of Indian folk tradition.</p>
    <div class="d-flex gap-3 justify-content-center flex-wrap">
  ...
  <div class="container py-3">
    <div class="row align-items-center g-5">
      <div class="col-lg-7">
        <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">Join Our Craft Community</p>
  ...
  <div class="container py-3">
    <div class="row justify-content-center">
      <div class="col-lg-6 text-center">
        <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">The Craft Journal</p>
        <h2 class="fw-bold mb-3" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.1rem;">Stay Close to the Craft</h2>
        ...
        <form>
          <div class="input-group mb-3" style="max-width:460px; margin:0 auto;">
            <input type="email" class="form-control form-control-lg" placeholder="Your email address" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
  ...
  <div class="container py-3">
    <div class="row g-5 align-items-start">
      <div class="col-lg-5">
        <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">Trade &amp; Wholesale</p>
        <h2 class="fw-bold mb-3" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.1rem;">Partner with Our Artisan Network</h2>
        ...
        <ul class="list-unstyled text-muted small">
          <li class="mb-2 d-flex gap-2"><span style="color:#f0a500; font-weight:700;">✦</span> Minimum order from 10 units per SKU</li>
          <li class="mb-2 d-flex gap-2"><span style="color:#f0a500; font-weight:700;">✦</span> Custom colourways and branding available</li>
          <li class="mb-2 d-flex gap-2"><span style="color:#f0a500; font-weight:700;">✦</span> Origin certificates and artisan documentation</li>
          <li class="mb-2 d-flex gap-2"><span style="color:#f0a500; font-weight:700;">✦</span> Dedicated account manager assigned</li>
        </ul>
      </div>
      <div class="col-lg-7">
        <div class="card p-4 p-lg-5" style="border:1.5px solid #e5d8c0; background:#fff;">
          <h5 class="fw-bold mb-4" style="color:#2d2f6b;">Send an Inquiry</h5>
          <form>
            <div class="row g-3">
              <div class="col-sm-6">
                <label class="form-label small fw-semibold" style="color:#2d2f6b;">Full Name</label>
                <input type="text" class="form-control" placeholder="Your name" style="border:1.5px solid #e5d8c0;">
              </div>
              <div class="col-sm-6">
                <label class="form-label small fw-semibold" style="color:#2d2f6b;">Business Name</label>
                <input type="text" class="form-control" placeholder="Your business" style="border:1.5px solid #e5d8c0;">
              </div>
              <div class="col-12">
                <label class="form-label small fw-semibold" style="color:#2d2f6b;">Email Address</label>
                <input type="email" class="form-control" placeholder="trade@yourbusiness.com" style="border:1.5px solid #e5d8c0;">
              </div>
              <div class="col-12">
                <label class="form-label small fw-semibold" style="color:#2d2f6b;">Craft Categories of Interest</label>
                <select class="form-select" style="border:1.5px solid #e5d8c0;">
              ...
              <div class="col-12">
                <label class="form-label small fw-semibold" style="color:#2d2f6b;">Tell Us About Your Requirements</label>
                <textarea class="form-control" rows="3" placeholder="Expected volumes, specific requirements, timelines..." style="border:1.5px solid #e5d8c0;"></textarea>
              </div>
              <div class="col-12">
  ...
  <div class="container py-3">
    <div class="text-center mb-5">
      <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">The Craft Box Subscription</p>
      <h2 class="fw-bold mb-2" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.3rem;">Handcrafted, Every Season</h2>
      <p class="text-muted">A curated selection of authentic artisan goods delivered to your door quarterly.</p>
    </div>
    <div class="row g-4 justify-content-center align-items-stretch">
      <div class="col-md-4">
        <div class="card h-100" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
          <div class="card-body p-4 p-lg-5 d-flex flex-column">
            <h5 class="fw-bold mb-1" style="color:#2d2f6b;">Patron</h5>
            <p class="text-muted small mb-4">For those beginning their craft journey</p>
            <div class="display-5 fw-bold mb-4" style="color:#2d2f6b;">₹999<small class="fs-5 text-muted fw-normal">/quarter</small></div>
            <ul class="list-unstyled mb-4 flex-grow-1">
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>2 handcrafted items</span></li>
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>Artisan story card</span></li>
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>Block-print gift wrap</span></li>
      ...
      <div class="col-md-4">
        <div class="card h-100 position-relative overflow-hidden" style="border:2px solid #f0a500; background:#fdf8f0;">
          <div class="position-absolute top-0 end-0 px-3 py-1" style="background:#f0a500;">
            <span class="fw-bold small" style="color:#2d2f6b;">Most Loved</span>
          </div>
          <div class="card-body p-4 p-lg-5 d-flex flex-column">
            <h5 class="fw-bold mb-1" style="color:#2d2f6b;">Heritage</h5>
            <p class="text-muted small mb-4">Our signature craft experience</p>
            <div class="display-5 fw-bold mb-4" style="color:#2d2f6b;">₹1,999<small class="fs-5 text-muted fw-normal">/quarter</small></div>
            <ul class="list-unstyled mb-4 flex-grow-1">
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>5 handcrafted items</span></li>
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>Artisan story card + photo</span></li>
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>Block-print gift wrap</span></li>
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>10% patron store discount</span></li>
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>Exclusive craft workshop invite</span></li>
            </ul>
      ...
      <div class="col-md-4">
        <div class="card h-100" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
          <div class="card-body p-4 p-lg-5 d-flex flex-column">
            <h5 class="fw-bold mb-1" style="color:#2d2f6b;">Connoisseur</h5>
            <p class="text-muted small mb-4">For the dedicated craft collector</p>
            <div class="display-5 fw-bold mb-4" style="color:#2d2f6b;">₹3,999<small class="fs-5 text-muted fw-normal">/quarter</small></div>
            <ul class="list-unstyled mb-4 flex-grow-1">
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>10 handcrafted items</span></li>
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>Personalised artisan letter</span></li>
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>Premium block-print packaging</span></li>
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>20% patron store discount</span></li>
              <li class="mb-2 d-flex gap-2"><i class="bi bi-check-circle-fill mt-1 flex-shrink-0" style="color:#f0a500;"></i><span>Annual artisan village visit</span></li>
            </ul>
            <a href="#" class="btn btn-secondary w-100 fw-semibold">Subscribe</a>
          </div>
        </div>
  ...
  <div class="container py-3">
    <div class="text-center mb-5">
      <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">Custom Commissions</p>
      <h2 class="fw-bold mb-2" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.3rem;">A Piece Made Just for You</h2>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-md-6 col-lg-4">
        <div class="card h-100 text-center" style="border:1.5px solid #e5d8c0; background:#fff;">
          <div class="card-body p-4">
            <div class="mb-3 rounded-2 mx-auto d-flex align-items-center justify-content-center" style="width:56px;height:56px;background:#2d2f6b;">
              <span style="color:#f0a500; font-size:1.5rem;">🪡</span>
            </div>
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Textile Commission</h6>
            <p class="text-muted small mb-3">Custom block-print yardage, handloom sarees, or embroidered table linen</p>
            <div class="fw-bold fs-4 mb-3" style="color:#2d2f6b;">From ₹3,500</div>
            <a href="#" class="btn btn-primary btn-sm w-100 fw-semibold">Request Quote</a>
          </div>
        </div>
      </div>
      <div class="col-md-6 col-lg-4">
        <div class="card h-100 text-center" style="border:2px solid #f0a500; background:#fff;">
          <div class="card-body p-4">
            <div class="mb-3 rounded-2 mx-auto d-flex align-items-center justify-content-center" style="width:56px;height:56px;background:#f0a500;">
              <span style="color:#2d2f6b; font-size:1.5rem;">🏺</span>
            </div>
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Ceramic Commission</h6>
            <p class="text-muted small mb-3">Hand-thrown and painted dinnerware sets, planters, and decorative vessels</p>
            <div class="fw-bold fs-4 mb-3" style="color:#2d2f6b;">From ₹2,200</div>
            <a href="#" class="btn btn-primary btn-sm w-100 fw-semibold">Request Quote</a>
          </div>
        </div>
      </div>
      <div class="col-md-6 col-lg-4">
        <div class="card h-100 text-center" style="border:1.5px solid #e5d8c0; background:#fff;">
          <div class="card-body p-4">
            ...
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Woven &amp; Basket Commission</h6>
            <p class="text-muted small mb-3">Custom bamboo furniture, storage baskets, and sculptural wall art</p>
            <div class="fw-bold fs-4 mb-3" style="color:#2d2f6b;">From ₹1,800</div>
            <a href="#" class="btn btn-primary btn-sm w-100 fw-semibold">Request Quote</a>
          </div>
        </div>
      </div>
  ...
  // ─── FOOTERS ─────────────────────────────────────────────────────────────────
  {
    ...
    html: `<footer style="background:#2d2f6b; color:rgba(255,255,255,0.85);">
  <div class="container py-5">
    <div class="row g-4">
      <div class="col-lg-4 col-md-6">
        <div class="fw-bold fs-5 mb-2" style="color:#f0a500; font-family:'EB Garamond', serif; letter-spacing:0.05em;">Craft House Indira</div>
        ...
        <div class="d-flex gap-3">
          <a href="#" style="color:#f0a500;"><i class="bi bi-instagram fs-5"></i></a>
          <a href="#" style="color:#f0a500;"><i class="bi bi-facebook fs-5"></i></a>
          <a href="#" style="color:#f0a500;"><i class="bi bi-pinterest fs-5"></i></a>
          <a href="#" style="color:#f0a500;"><i class="bi bi-youtube fs-5"></i></a>
        </div>
      </div>
      <div class="col-lg-2 col-md-6 col-sm-6">
        <h6 class="fw-bold mb-3" style="color:#f0a500;">Collections</h6>
      ...
      <div class="col-lg-2 col-md-6 col-sm-6">
        <h6 class="fw-bold mb-3" style="color:#f0a500;">About</h6>
        <ul class="list-unstyled small">
      ...
      <div class="col-lg-4 col-md-6">
        <h6 class="fw-bold mb-3" style="color:#f0a500;">The Craft Journal</h6>
  ...
  },
  {
    ...
    html: `<footer style="background:#fdf8f0; border-top:3px solid #f0a500;">
  <div class="container py-5">
    <div class="row g-4 justify-content-between">
      <div class="col-lg-5">
        <div class="fw-bold fs-5 mb-2" style="color:#2d2f6b; font-family:'EB Garamond', serif;">The Folk Loom</div>
        ...
        <div class="d-flex gap-3">
          <a href="#" style="color:#2d2f6b;"><i class="bi bi-instagram"></i></a>
          <a href="#" style="color:#2d2f6b;"><i class="bi bi-facebook"></i></a>
          <a href="#" style="color:#2d2f6b;"><i class="bi bi-pinterest"></i></a>
        </div>
      </div>
      <div class="col-sm-4 col-lg-2">
        <h6 class="fw-bold mb-3" style="color:#2d2f6b;">Shop</h6>
      ...
      <div class="col-sm-4 col-lg-2">
        <h6 class="fw-bold mb-3" style="color:#2d2f6b;">Help</h6>
        <ul class="list-unstyled small text-muted">
  ...
  <div style="border-top:1px solid #e5d8c0;">
  ...
  <div class="container py-3">
    <div class="text-center mb-5">
      <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">The Craft in Images</p>
      <h2 class="fw-bold" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.2rem;">A Visual Journey Through Heritage</h2>
    </div>
    <div class="row g-3">
      <div class="col-md-8">
  ...
  <div class="container py-3">
    <div class="text-center mb-5">
      <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">Artisan at Work</p>
      <h2 class="fw-bold" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.2rem;">The Making of Craft</h2>
    </div>
    <div class="row g-3">
  ...
  // ─── SOCIAL PROOF ────────────────────────────────────────────────────────────
  {
    ...
    html: `<section class="py-4 bg-light" style="border-top:2px solid #e5d8c0; border-bottom:2px solid #e5d8c0;">
  <div class="container">
    <div class="row align-items-center g-3">
      <div class="col-12 col-md-3 text-center text-md-start">
        <p class="small fw-semibold text-uppercase mb-0" style="letter-spacing:0.1em; color:#f0a500;">As Featured In</p>
      </div>
  ...
  <div class="container py-3">
    <div class="row text-center g-4 mb-5">
      <div class="col-6 col-md-3">
        <div class="fw-bold" style="font-size:2.8rem; color:#f0a500; font-family:'EB Garamond', serif;">500+</div>
        <div class="small" style="opacity:0.75;">Artisan Families Supported</div>
      </div>
      <div class="col-6 col-md-3">
        <div class="fw-bold" style="font-size:2.8rem; color:#f0a500; font-family:'EB Garamond', serif;">28</div>
        <div class="small" style="opacity:0.75;">Living Craft Traditions</div>
      </div>
      <div class="col-6 col-md-3">
        <div class="fw-bold" style="font-size:2.8rem; color:#f0a500; font-family:'EB Garamond', serif;">15k+</div>
        <div class="small" style="opacity:0.75;">Pieces Sold Worldwide</div>
      </div>
      <div class="col-6 col-md-3">
        <div class="fw-bold" style="font-size:2.8rem; color:#f0a500; font-family:'EB Garamond', serif;">4.9★</div>
        <div class="small" style="opacity:0.75;">Average Patron Rating</div>
      </div>
    </div>
    <div class="row justify-content-center g-3 text-center">
      <div class="col-12 mb-3">
        <p class="text-uppercase fw-semibold mb-0" style="letter-spacing:0.12em; color:#f0a500; opacity:0.8; font-size:0.8rem;">Awards &amp; Recognition</p>
      </div>
      <div class="col-6 col-md-3">
        <div class="p-3 rounded-2" style="background:rgba(255,255,255,0.07); border:1px solid rgba(240,165,0,0.3);">
          <div class="fw-semibold small mb-1" style="color:#f0a500;">National Crafts Council</div>
          <div class="small" style="opacity:0.65;">Best Heritage Brand 2023</div>
        </div>
      </div>
      <div class="col-6 col-md-3">
        <div class="p-3 rounded-2" style="background:rgba(255,255,255,0.07); border:1px solid rgba(240,165,0,0.3);">
          <div class="fw-semibold small mb-1" style="color:#f0a500;">GI Certification</div>
          <div class="small" style="opacity:0.65;">14 Verified Craft Origins</div>
        </div>
      </div>
      <div class="col-6 col-md-3">
        <div class="p-3 rounded-2" style="background:rgba(255,255,255,0.07); border:1px solid rgba(240,165,0,0.3);">
          <div class="fw-semibold small mb-1" style="color:#f0a500;">UNESCO Nominee</div>
          <div class="small" style="opacity:0.65;">Living Heritage Partner</div>
        </div>
      </div>
      <div class="col-6 col-md-3">
        <div class="p-3 rounded-2" style="background:rgba(255,255,255,0.07); border:1px solid rgba(240,165,0,0.3);">
          <div class="fw-semibold small mb-1" style="color:#f0a500;">Vogue India</div>
  ...
  <div class="container py-3">
    <div class="text-center mb-5">
      <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">The Craft Process</p>
      <h2 class="fw-bold" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.3rem;">From Loom to Your Doorstep</h2>
    ...
    <div class="row g-4">
      <div class="col-md-3 text-center">
        <div class="rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center fw-bold" style="width:60px;height:60px;background:#2d2f6b;color:#f0a500;font-size:1.4rem;font-family:'EB Garamond',serif;">01</div>
        <h6 class="fw-bold mb-2" style="color:#2d2f6b;">Sourcing Materials</h6>
      ...
      <div class="col-md-3 text-center">
        <div class="rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center fw-bold" style="width:60px;height:60px;background:#2d2f6b;color:#f0a500;font-size:1.4rem;font-family:'EB Garamond',serif;">02</div>
        <h6 class="fw-bold mb-2" style="color:#2d2f6b;">Natural Dyeing</h6>
      ...
      <div class="col-md-3 text-center">
        <div class="rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center fw-bold" style="width:60px;height:60px;background:#2d2f6b;color:#f0a500;font-size:1.4rem;font-family:'EB Garamond',serif;">03</div>
        <h6 class="fw-bold mb-2" style="color:#2d2f6b;">Handcrafting</h6>
      ...
      <div class="col-md-3 text-center">
        <div class="rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center fw-bold" style="width:60px;height:60px;background:#f0a500;color:#2d2f6b;font-size:1.4rem;font-family:'EB Garamond',serif;">04</div>
        <h6 class="fw-bold mb-2" style="color:#2d2f6b;">Curated &amp; Shipped</h6>
  ...
  <div class="container py-3">
    <div class="text-center mb-5">
      <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">How to Commission</p>
      <h2 class="fw-bold" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.3rem;">A Bespoke Piece in 4 Simple Steps</h2>
    </div>
    <div class="row g-4 align-items-start">
      <div class="col-md-6 col-lg-3">
        <div class="card h-100 p-4 text-center" style="border:1.5px solid #e5d8c0; background:#fff;">
          <div class="mb-3" style="font-size:2rem; color:#f0a500;">📋</div>
          <div class="fw-bold small mb-1" style="color:#f0a500;">Step 01</div>
          <h6 class="fw-bold mb-2" style="color:#2d2f6b;">Tell Us Your Vision</h6>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card h-100 p-4 text-center" style="border:1.5px solid #e5d8c0; background:#fff;">
          <div class="mb-3" style="font-size:2rem; color:#f0a500;">🎨</div>
          <div class="fw-bold small mb-1" style="color:#f0a500;">Step 02</div>
          <h6 class="fw-bold mb-2" style="color:#2d2f6b;">Design Consultation</h6>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card h-100 p-4 text-center" style="border:1.5px solid #e5d8c0; background:#fff;">
          <div class="mb-3" style="font-size:2rem; color:#f0a500;">🪡</div>
          <div class="fw-bold small mb-1" style="color:#f0a500;">Step 03</div>
          <h6 class="fw-bold mb-2" style="color:#2d2f6b;">Artisan Creates</h6>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="card h-100 p-4 text-center" style="border:1.5px solid #e5d8c0; background:#fff;">
          <div class="mb-3" style="font-size:2rem; color:#f0a500;">📦</div>
          <div class="fw-bold small mb-1" style="color:#f0a500;">Step 04</div>
          <h6 class="fw-bold mb-2" style="color:#2d2f6b;">Delivered with Care</h6>
  ...
  <div class="container py-3">
    <div class="text-center mb-5">
      <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.12em; color:#f0a500;">New Arrivals</p>
      <h2 class="fw-bold" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2.3rem;">Fresh from the Artisan's Hands</h2>
    </div>
    <div class="row g-4">
      <div class="col-sm-6 col-lg-3">
        <div class="card h-100 overflow-hidden" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
          <div class="position-relative">
            ...
            <span class="position-absolute top-0 start-0 m-2 badge" style="background:#f0a500; color:#2d2f6b;">New</span>
          </div>
          <div class="card-body d-flex flex-column">
            <p class="small mb-1" style="color:#f0a500; font-weight:600;">Block Print</p>
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Indigo Floral Stole</h6>
            <p class="text-muted small mb-2">By Meera Kumari, Sanganer</p>
            <div class="d-flex justify-content-between align-items-center mt-auto">
              <span class="fw-bold" style="color:#2d2f6b;">₹1,200</span>
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card h-100 overflow-hidden" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
          <div class="position-relative">
            ...
            <span class="position-absolute top-0 start-0 m-2 badge" style="background:#2d2f6b; color:#f0a500;">Bestseller</span>
          </div>
          <div class="card-body d-flex flex-column">
            <p class="small mb-1" style="color:#f0a500; font-weight:600;">Ceramics</p>
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Hand-painted Serving Bowl</h6>
            <p class="text-muted small mb-2">By Rajan Prajapat, Khurja</p>
            <div class="d-flex justify-content-between align-items-center mt-auto">
              <span class="fw-bold" style="color:#2d2f6b;">₹850</span>
              <a href="#" class="btn btn-primary btn-sm px-3 fw-semibold">Add to Cart</a>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card h-100 overflow-hidden" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
          ...
          <div class="card-body d-flex flex-column">
            <p class="small mb-1" style="color:#f0a500; font-weight:600;">Embroidery</p>
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Phulkari Cushion Cover</h6>
            <p class="text-muted small mb-2">Punjab Embroidery Collective</p>
            <div class="d-flex justify-content-between align-items-center mt-auto">
              <span class="fw-bold" style="color:#2d2f6b;">₹680</span>
              <a href="#" class="btn btn-primary btn-sm px-3 fw-semibold">Add to Cart</a>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card h-100 overflow-hidden" style="border:1.5px solid #e5d8c0; background:#fdf8f0;">
          <div class="position-relative">
            ...
            <span class="position-absolute top-0 start-0 m-2 badge" style="background:#2d2f6b; color:#f0a500;">Limited</span>
          </div>
          <div class="card-body d-flex flex-column">
            <p class="small mb-1" style="color:#f0a500; font-weight:600;">Basket Weaving</p>
            <h6 class="fw-bold mb-1" style="color:#2d2f6b;">Bamboo Serving Tray Set</h6>
            <p class="text-muted small mb-2">By Fathima Bi, Nirmal</p>
            <div class="d-flex justify-content-between align-items-center mt-auto">
              <span class="fw-bold" style="color:#2d2f6b;">₹1,450</span>
              <a href="#" class="btn btn-primary btn-sm px-3 fw-semibold">Add to Cart</a>
            </div>
          </div>
        </div>
    ...
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        <div class="row g-2">
          ...
          <div class="col-4">
            <img src="https://images.unsplash.com/photo-1524117074681-31bd4de22ad3?w=800&q=80" alt="Loom detail" class="img-fluid rounded-2" style="height:90px; width:100%; object-fit:cover; border:2px solid #e5d8c0;">
          </div>
          <div class="col-4">
            <img src="https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?w=800&q=80" alt="Dye process" class="img-fluid rounded-2" style="height:90px; width:100%; object-fit:cover; border:2px solid #e5d8c0;">
          </div>
          <div class="col-4">
            <img src="https://images.unsplash.com/photo-1578301978018-3005759f48f7?w=800&q=80" alt="Artisan" class="img-fluid rounded-2" style="height:90px; width:100%; object-fit:cover; border:2px solid #e5d8c0;">
          </div>
        </div>
      </div>
      <div class="col-lg-6">
        <p class="text-uppercase fw-semibold mb-2" style="letter-spacing:0.1em; color:#f0a500;">Handloom Textiles</p>
        <h2 class="fw-bold mb-2" style="font-family:'EB Garamond', serif; color:#2d2f6b; font-size:2rem;">Double Ikat Silk Throw</h2>
        ...
        <div class="mb-3">
          <span class="fw-bold" style="color:#2d2f6b; font-size:1.8rem;">₹4,800</span>
          <span class="text-decoration-line-through text-muted ms-2 small">₹6,200</span>
          <span class="badge ms-2" style="background:#f0a500; color:#2d2f6b;">Save 22%</span>
        </div>
        ...
        <div class="mb-3">
          <span class="fw-semibold small me-3" style="color:#2d2f6b;">Colour:</span>
          <button class="btn btn-sm rounded-pill me-2 fw-semibold" style="background:#2d2f6b; color:#f0a500; border:none; font-size:0.75rem;">Indigo &amp; Saffron</button>
          <button class="btn btn-sm rounded-pill me-2 fw-semibold" style="background:#fdf8f0; color:#2d2f6b; border:1.5px solid #e5d8c0; font-size:0.75rem;">Rust &amp; Cream</button>
        </div>
