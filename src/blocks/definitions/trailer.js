export const trailerBlocks = [
  ...
  // 1. Navigation — site header
  {
    ...
    html: `<nav style="background:var(--bs-dark);">
  <!-- Top utility bar -->
  <div style="background:var(--bs-primary); color:#fff; font-size:0.8rem; padding:6px 0;">
  ...
  <div class="container py-3 d-flex justify-content-between align-items-center">
    ...
    <div class="d-none d-lg-flex align-items-center gap-4">
      <a href="#" style="color:var(--bs-dark-text); text-decoration:none; font-size:0.9rem; font-weight:500; opacity:0.9;">Home</a>
      <a href="#" style="color:var(--bs-dark-text); text-decoration:none; font-size:0.9rem; font-weight:500; opacity:0.9;">All Inventory</a>
      <a href="#" style="color:var(--bs-dark-text); text-decoration:none; font-size:0.9rem; font-weight:500; opacity:0.9;">Financing</a>
      <a href="#" style="color:var(--bs-dark-text); text-decoration:none; font-size:0.9rem; font-weight:500; opacity:0.9;">Parts &amp; Service</a>
      <a href="#" style="color:var(--bs-dark-text); text-decoration:none; font-size:0.9rem; font-weight:500; opacity:0.9;">Contact Us</a>
      <a href="#" class="btn btn-primary btn-sm px-4 fw-bold" style="border-radius:6px;">Browse Inventory</a>
    </div>
    <button class="d-lg-none btn btn-sm" style="color:var(--bs-dark-text); border:1px solid color-mix(in srgb, var(--bs-dark-text) 30%, transparent);">
  ...
  <div style="position:absolute; inset:0; background:color-mix(in srgb, var(--bs-dark) 72%, transparent);"></div>
  <div class="container position-relative py-5 text-white">
    <div class="row justify-content-start">
      <div class="col-lg-7 col-xl-6">
        <span class="badge bg-primary mb-4 px-3 py-2" style="font-size:0.72rem; letter-spacing:2.5px; font-weight:700; border-radius:4px;">MICHIGAN'S LARGEST TRAILER DEALER</span>
        ...
        <p class="lead mb-5" style="color:color-mix(in srgb, var(--bs-dark-text) 82%, transparent); max-width:540px; line-height:1.7;">With 7 locations across Michigan and thousands of trailers in stock, USA Trailer Sales has everything you need &mdash; from utility trailers to heavy equipment haulers.</p>
        <div class="d-flex flex-wrap gap-3 mb-5">
          <a href="#" class="btn btn-primary btn-lg px-5 fw-bold" style="border-radius:8px;">Browse All Inventory</a>
          <a href="#" class="btn btn-outline-light btn-lg px-4 fw-bold" style="border-radius:8px;">Get Financing</a>
        </div>
        <!-- Trust stats -->
        <div class="d-flex gap-5 flex-wrap">
          <div>
            <div class="fw-black" style="font-size:2rem; color:var(--bs-primary); line-height:1;">50+</div>
            <div style="font-size:0.8rem; color:color-mix(in srgb, var(--bs-dark-text) 65%, transparent); margin-top:2px;">Years in<br>Business</div>
          </div>
          <div>
            <div class="fw-black" style="font-size:2rem; color:var(--bs-primary); line-height:1;">7</div>
            <div style="font-size:0.8rem; color:color-mix(in srgb, var(--bs-dark-text) 65%, transparent); margin-top:2px;">Michigan<br>Locations</div>
          </div>
          <div>
            <div class="fw-black" style="font-size:2rem; color:var(--bs-primary); line-height:1;">1,000s</div>
            <div style="font-size:0.8rem; color:color-mix(in srgb, var(--bs-dark-text) 65%, transparent); margin-top:2px;">Trailers<br>In Stock</div>
          </div>
        </div>
      </div>
    </div>
  ...
  // 3. Category Grid
  {
    ...
    html: `<section style="background:var(--bs-light); padding:80px 0;">
  <div class="container">
    <div class="text-center mb-5">
      <span class="badge bg-primary mb-3 px-3 py-2" style="font-size:0.72rem; letter-spacing:2.5px; font-weight:700; border-radius:4px;">SHOP NOW</span>
      <h2 class="fw-black mb-3" style="font-size:clamp(1.8rem,3.5vw,2.6rem); color:var(--bs-heading-color);">Shop by Category</h2>
      <p style="color:var(--bs-body-color); max-width:520px; margin:0 auto;">Michigan&apos;s widest selection of quality trailers for every need and budget.</p>
    </div>
    <div class="row g-4">
      <!-- Equipment -->
      <div class="col-6 col-lg-3">
        <div class="card border-0 shadow-sm h-100" style="border-radius:14px; overflow:hidden;">
          <div style="aspect-ratio:4/3; overflow:hidden; background:var(--bs-light);">
          ...
          <div class="card-body p-4">
            <h5 class="fw-bold mb-2" style="color:var(--bs-heading-color); font-size:1.05rem;">Equipment Trailers</h5>
            <p class="mb-3" style="color:var(--bs-body-color); font-size:0.85rem; line-height:1.6;">Heavy-duty trailers built for machinery, vehicles, and oversized loads.</p>
            <a href="#" style="color:var(--bs-primary); font-weight:700; font-size:0.88rem; text-decoration:none;">Browse &rarr;</a>
          </div>
        </div>
      </div>
      <!-- Utility -->
      <div class="col-6 col-lg-3">
        <div class="card border-0 shadow-sm h-100" style="border-radius:14px; overflow:hidden;">
          ...
          <div class="card-body p-4">
            <h5 class="fw-bold mb-2" style="color:var(--bs-heading-color); font-size:1.05rem;">Landscape &amp; Utility</h5>
            <p class="mb-3" style="color:var(--bs-body-color); font-size:0.85rem; line-height:1.6;">Versatile open trailers perfect for landscaping, hauling, and everyday work.</p>
            <a href="#" style="color:var(--bs-primary); font-weight:700; font-size:0.88rem; text-decoration:none;">Browse &rarr;</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-6 col-lg-3">
        <div class="card border-0 shadow-sm h-100" style="border-radius:14px; overflow:hidden;">
          ...
          <div class="card-body p-4">
            <h5 class="fw-bold mb-2" style="color:var(--bs-heading-color); font-size:1.05rem;">Cargo &amp; Enclosed</h5>
            <p class="mb-3" style="color:var(--bs-body-color); font-size:0.85rem; line-height:1.6;">Secure your cargo with our wide range of enclosed trailer options.</p>
            <a href="#" style="color:var(--bs-primary); font-weight:700; font-size:0.88rem; text-decoration:none;">Browse &rarr;</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-6 col-lg-3">
        <div class="card border-0 shadow-sm h-100" style="border-radius:14px; overflow:hidden;">
          ...
          <div class="card-body p-4">
            <h5 class="fw-bold mb-2" style="color:var(--bs-heading-color); font-size:1.05rem;">Dump Trailers</h5>
            <p class="mb-3" style="color:var(--bs-body-color); font-size:0.85rem; line-height:1.6;">Hydraulic dump trailers for construction, landscaping, and debris removal.</p>
            <a href="#" style="color:var(--bs-primary); font-weight:700; font-size:0.88rem; text-decoration:none;">Browse &rarr;</a>
          </div>
        </div>
      </div>
    ...
    <div class="text-center mt-5">
      <a href="#" class="btn btn-dark btn-lg px-5 fw-bold" style="border-radius:8px;">View All Categories</a>
    </div>
  </div>
</section>`
  },
  ...
  // 4. Why Choose Us (Stats + Features)
  {
    ...
    html: `<section style="background:var(--bs-dark); padding:80px 0; color:var(--bs-dark-text);">
  <div class="container">
    <div class="text-center mb-5">
      <span class="badge bg-primary mb-3 px-3 py-2" style="font-size:0.72rem; letter-spacing:2.5px; font-weight:700; border-radius:4px;">OUR PROMISE</span>
      <h2 class="fw-black mb-3" style="font-size:clamp(1.8rem,3.5vw,2.6rem); color:var(--bs-dark-text);">Why Choose USA Trailer Sales?</h2>
      <p style="color:color-mix(in srgb, var(--bs-dark-text) 60%, transparent); max-width:560px; margin:0 auto;">Michigan&apos;s most trusted trailer dealership &mdash; delivering quality, value, and service for over 50 years.</p>
    </div>
    <!-- Stat cards -->
    <div class="row g-4 mb-5">
      <div class="col-6 col-lg-3">
        <div class="text-center p-4 rounded-3" style="background:color-mix(in srgb, var(--bs-dark) 85%, var(--bs-light));">
          <div style="font-size:2.8rem; line-height:1; color:var(--bs-primary); font-weight:900;">50+</div>
          <div class="fw-bold mt-2" style="font-size:1rem; color:var(--bs-dark-text);">Years in Business</div>
          <div style="font-size:0.78rem; color:color-mix(in srgb, var(--bs-dark-text) 50%, transparent); margin-top:4px;">Family owned since 1972</div>
        </div>
      </div>
      <div class="col-6 col-lg-3">
        <div class="text-center p-4 rounded-3" style="background:color-mix(in srgb, var(--bs-dark) 85%, var(--bs-light));">
          <div style="font-size:2.8rem; line-height:1; color:var(--bs-primary); font-weight:900;">7</div>
          <div class="fw-bold mt-2" style="font-size:1rem; color:var(--bs-dark-text);">Michigan Locations</div>
          <div style="font-size:0.78rem; color:color-mix(in srgb, var(--bs-dark-text) 50%, transparent); margin-top:4px;">Across the entire state</div>
        </div>
      </div>
      <div class="col-6 col-lg-3">
        <div class="text-center p-4 rounded-3" style="background:color-mix(in srgb, var(--bs-dark) 85%, var(--bs-light));">
          <div style="font-size:2.8rem; line-height:1; color:var(--bs-primary); font-weight:900;">1,000s</div>
          <div class="fw-bold mt-2" style="font-size:1rem; color:var(--bs-dark-text);">Trailers In Stock</div>
          <div style="font-size:0.78rem; color:color-mix(in srgb, var(--bs-dark-text) 50%, transparent); margin-top:4px;">New &amp; used available</div>
        </div>
      </div>
      <div class="col-6 col-lg-3">
        <div class="text-center p-4 rounded-3" style="background:color-mix(in srgb, var(--bs-dark) 85%, var(--bs-light));">
          <div style="font-size:2.8rem; line-height:1; color:var(--bs-primary); font-weight:900;">5&#9733;</div>
          <div class="fw-bold mt-2" style="font-size:1rem; color:var(--bs-dark-text);">Expert Staff</div>
          <div style="font-size:0.78rem; color:color-mix(in srgb, var(--bs-dark-text) 50%, transparent); margin-top:4px;">Knowledgeable &amp; friendly</div>
        </div>
      </div>
    </div>
    <!-- Feature bullets -->
    <div class="row g-3 mb-5">
      <div class="col-md-6">
        <div class="d-flex align-items-start gap-3 p-3 rounded-3" style="background:color-mix(in srgb, var(--bs-dark) 85%, var(--bs-light));">
          <span style="font-size:1.4rem; line-height:1.4;">&#127942;</span>
          <div>
            <div class="fw-bold mb-1" style="color:var(--bs-dark-text);">Top Brand Selection</div>
            <div style="color:color-mix(in srgb, var(--bs-dark-text) 58%, transparent); font-size:0.85rem;">We carry Big Tex, PJ, Load Trail, Carry-On, and more top brands.</div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="d-flex align-items-start gap-3 p-3 rounded-3" style="background:color-mix(in srgb, var(--bs-dark) 85%, var(--bs-light));">
          <span style="font-size:1.4rem; line-height:1.4;">&#128176;</span>
          <div>
            <div class="fw-bold mb-1" style="color:var(--bs-dark-text);">Competitive Pricing</div>
            <div style="color:color-mix(in srgb, var(--bs-dark-text) 58%, transparent); font-size:0.85rem;">Best prices in Michigan &mdash; we&apos;ll match any competitor&apos;s written quote.</div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="d-flex align-items-start gap-3 p-3 rounded-3" style="background:color-mix(in srgb, var(--bs-dark) 85%, var(--bs-light));">
          <span style="font-size:1.4rem; line-height:1.4;">&#128295;</span>
          <div>
            <div class="fw-bold mb-1" style="color:var(--bs-dark-text);">Full Service Department</div>
            <div style="color:color-mix(in srgb, var(--bs-dark-text) 58%, transparent); font-size:0.85rem;">Repairs, parts, and inspections &mdash; all in-house by certified technicians.</div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="d-flex align-items-start gap-3 p-3 rounded-3" style="background:color-mix(in srgb, var(--bs-dark) 85%, var(--bs-light));">
          <span style="font-size:1.4rem; line-height:1.4;">&#128203;</span>
          <div>
            <div class="fw-bold mb-1" style="color:var(--bs-dark-text);">Easy Financing</div>
            <div style="color:color-mix(in srgb, var(--bs-dark-text) 58%, transparent); font-size:0.85rem;">All credit situations considered &mdash; fast approvals and low monthly rates.</div>
          </div>
        </div>
      </div>
    </div>
    <div class="text-center">
      <a href="#" class="btn btn-primary btn-lg px-5 fw-bold me-3" style="border-radius:8px;">Browse All Inventory</a>
      <a href="#" class="btn btn-outline-light btn-lg px-4" style="border-radius:8px;">Contact Us</a>
    </div>
  </div>
</section>`
  },
  ...
  // 5. About / Inventory Intro
  {
    ...
    html: `<section style="background:var(--bs-body-bg); padding:80px 0;">
  <div class="container">
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        <div style="position:relative; display:inline-block; width:100%;">
          ...
          <div style="position:absolute; bottom:24px; left:-16px; background:var(--bs-primary); color:#fff; padding:14px 20px; border-radius:10px; box-shadow:0 8px 24px color-mix(in srgb, var(--bs-primary) 40%, transparent);">
      ...
      <div class="col-lg-6">
        <span class="badge bg-primary mb-3 px-3 py-2" style="font-size:0.72rem; letter-spacing:2.5px; font-weight:700; border-radius:4px;">MICHIGAN'S #1 TRAILER DEALER</span>
        <h2 class="fw-black mb-4" style="font-size:clamp(1.7rem,3vw,2.4rem); color:var(--bs-heading-color); line-height:1.2;">Michigan&apos;s #1 Source for<br>New &amp; Used Trailers</h2>
        <p style="color:var(--bs-body-color); line-height:1.8; margin-bottom:1.5rem;">From everyday utility trailers to heavy equipment haulers, USA Trailer Sales carries the largest selection of trailers in Michigan. We stock top brands at unbeatable prices &mdash; ready to drive away today.</p>
        <ul style="list-style:none; padding:0; margin-bottom:2rem;">
          <li class="d-flex align-items-center gap-2 mb-2" style="color:var(--bs-body-color);"><span style="color:var(--bs-primary); font-weight:800;">&#10003;</span> Utility, Equipment, Cargo &amp; Dump Trailers</li>
          <li class="d-flex align-items-center gap-2 mb-2" style="color:var(--bs-body-color);"><span style="color:var(--bs-primary); font-weight:800;">&#10003;</span> New &amp; Certified Pre-Owned Options</li>
          <li class="d-flex align-items-center gap-2 mb-2" style="color:var(--bs-body-color);"><span style="color:var(--bs-primary); font-weight:800;">&#10003;</span> Custom Configurations Available</li>
          <li class="d-flex align-items-center gap-2 mb-2" style="color:var(--bs-body-color);"><span style="color:var(--bs-primary); font-weight:800;">&#10003;</span> Same-Day Walk-Out Possible at All Locations</li>
        </ul>
        <a href="#" class="btn btn-primary btn-lg px-5 fw-bold" style="border-radius:8px;">View All Inventory &rarr;</a>
      </div>
    </div>
  </div>
</section>`
  ...
  <div class="container">
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        <span class="badge bg-primary mb-3 px-3 py-2" style="font-size:0.72rem; letter-spacing:2.5px; font-weight:700; border-radius:4px;">TRAILER FINANCING</span>
        <h2 class="fw-black mb-4" style="font-size:clamp(1.7rem,3vw,2.4rem); color:var(--bs-heading-color); line-height:1.2;">Flexible Financing Available</h2>
        <p style="color:var(--bs-body-color); line-height:1.8; margin-bottom:1.5rem;">We work with all credit situations to get you into the trailer you need. Our fast, hassle-free financing process makes owning a trailer easier than ever.</p>
        <ul style="list-style:none; padding:0; margin-bottom:2rem;">
          <li class="d-flex align-items-center gap-2 mb-2" style="color:var(--bs-body-color);"><span style="color:var(--bs-primary); font-weight:800;">&#10003;</span> All credit types accepted</li>
          <li class="d-flex align-items-center gap-2 mb-2" style="color:var(--bs-body-color);"><span style="color:var(--bs-primary); font-weight:800;">&#10003;</span> Low monthly payments available</li>
          <li class="d-flex align-items-center gap-2 mb-2" style="color:var(--bs-body-color);"><span style="color:var(--bs-primary); font-weight:800;">&#10003;</span> Quick approval &mdash; same day decisions</li>
          <li class="d-flex align-items-center gap-2 mb-2" style="color:var(--bs-body-color);"><span style="color:var(--bs-primary); font-weight:800;">&#10003;</span> Competitive interest rates</li>
        </ul>
        <div class="d-flex flex-wrap gap-3">
          <a href="#" class="btn btn-primary btn-lg px-5 fw-bold" style="border-radius:8px;">Apply for Financing</a>
          <a href="#" class="btn btn-outline-dark btn-lg px-4" style="border-radius:8px;">Learn More</a>
        </div>
      </div>
      <div class="col-lg-6">
  ...
  <div class="container text-center">
    <span class="badge bg-primary mb-3 px-3 py-2" style="font-size:0.72rem; letter-spacing:2.5px; font-weight:700; border-radius:4px;">FIND US</span>
    <h2 class="fw-black mb-3" style="font-size:clamp(1.8rem,3.5vw,2.6rem); color:var(--bs-heading-color);">7 Convenient Michigan Locations</h2>
    <p style="color:var(--bs-body-color); max-width:560px; margin:0 auto 2.5rem;">Visit any of our statewide dealerships for the best selection, pricing, and expert service in Michigan.</p>
    <!-- Map image -->
    <div class="mb-4">
    ...
    <div class="d-flex flex-wrap justify-content-center gap-2 mb-5">
      <span class="px-3 py-2 rounded-pill fw-semibold" style="background:var(--bs-light); color:var(--bs-heading-color); font-size:0.88rem; border:1px solid var(--bs-border-color);">&#128205; Edmore</span>
      <span class="px-3 py-2 rounded-pill fw-semibold" style="background:var(--bs-light); color:var(--bs-heading-color); font-size:0.88rem; border:1px solid var(--bs-border-color);">&#128205; Ionia</span>
      <span class="px-3 py-2 rounded-pill fw-semibold" style="background:var(--bs-light); color:var(--bs-heading-color); font-size:0.88rem; border:1px solid var(--bs-border-color);">&#128205; New Boston</span>
      <span class="px-3 py-2 rounded-pill fw-semibold" style="background:var(--bs-light); color:var(--bs-heading-color); font-size:0.88rem; border:1px solid var(--bs-border-color);">&#128205; Wayland</span>
      <span class="px-3 py-2 rounded-pill fw-semibold" style="background:var(--bs-light); color:var(--bs-heading-color); font-size:0.88rem; border:1px solid var(--bs-border-color);">&#128205; Grayling</span>
      <span class="px-3 py-2 rounded-pill fw-semibold" style="background:var(--bs-light); color:var(--bs-heading-color); font-size:0.88rem; border:1px solid var(--bs-border-color);">&#128205; Monroe</span>
      <span class="px-3 py-2 rounded-pill fw-semibold" style="background:var(--bs-light); color:var(--bs-heading-color); font-size:0.88rem; border:1px solid var(--bs-border-color);">&#128205; Traverse City</span>
    </div>
    <a href="#" class="btn btn-primary btn-lg px-5 fw-bold" style="border-radius:8px;">Find Your Nearest Location</a>
  </div>
</section>`
  },
  ...
  // 8. Parts & Service
  {
    ...
    html: `<section style="background:var(--bs-dark); padding:80px 0;">
  <div class="container">
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
      ...
      <div class="col-lg-6 text-white">
        <span class="badge bg-primary mb-3 px-3 py-2" style="font-size:0.72rem; letter-spacing:2.5px; font-weight:700; border-radius:4px;">PARTS &amp; SERVICE</span>
        <h2 class="fw-black mb-4" style="font-size:clamp(1.7rem,3vw,2.4rem); color:var(--bs-dark-text); line-height:1.2;">Expert Trailer Parts &amp; Service</h2>
        <p style="color:color-mix(in srgb, var(--bs-dark-text) 62%, transparent); line-height:1.8; margin-bottom:2rem;">Our certified technicians handle everything from routine maintenance to major repairs. We stock a full inventory of OEM and aftermarket trailer parts at all locations.</p>
        <ul style="list-style:none; padding:0; margin-bottom:2rem;">
          <li class="d-flex align-items-center gap-3 mb-3">
            <span class="d-inline-flex align-items-center justify-content-center fw-bold" style="width:30px; height:30px; min-width:30px; background:var(--bs-primary); border-radius:50%; font-size:0.8rem; color:#fff;">&#10003;</span>
            <span style="color:color-mix(in srgb, var(--bs-dark-text) 82%, transparent);">Brake inspections &amp; replacement</span>
          </li>
          <li class="d-flex align-items-center gap-3 mb-3">
            <span class="d-inline-flex align-items-center justify-content-center fw-bold" style="width:30px; height:30px; min-width:30px; background:var(--bs-primary); border-radius:50%; font-size:0.8rem; color:#fff;">&#10003;</span>
            <span style="color:color-mix(in srgb, var(--bs-dark-text) 82%, transparent);">Axle replacement &amp; wheel alignment</span>
          </li>
          <li class="d-flex align-items-center gap-3 mb-3">
            <span class="d-inline-flex align-items-center justify-content-center fw-bold" style="width:30px; height:30px; min-width:30px; background:var(--bs-primary); border-radius:50%; font-size:0.8rem; color:#fff;">&#10003;</span>
            <span style="color:color-mix(in srgb, var(--bs-dark-text) 82%, transparent);">Electrical wiring &amp; lighting repair</span>
          </li>
          <li class="d-flex align-items-center gap-3 mb-3">
            <span class="d-inline-flex align-items-center justify-content-center fw-bold" style="width:30px; height:30px; min-width:30px; background:var(--bs-primary); border-radius:50%; font-size:0.8rem; color:#fff;">&#10003;</span>
            <span style="color:color-mix(in srgb, var(--bs-dark-text) 82%, transparent);">Tire service &amp; replacement</span>
          </li>
          <li class="d-flex align-items-center gap-3 mb-3">
            <span class="d-inline-flex align-items-center justify-content-center fw-bold" style="width:30px; height:30px; min-width:30px; background:var(--bs-primary); border-radius:50%; font-size:0.8rem; color:#fff;">&#10003;</span>
            <span style="color:color-mix(in srgb, var(--bs-dark-text) 82%, transparent);">Roof &amp; panel repair</span>
          </li>
        </ul>
        <a href="#" class="btn btn-primary btn-lg px-5 fw-bold" style="border-radius:8px;">Visit Our Service Department</a>
      </div>
    </div>
  </div>
</section>`
  ...
  // 9. Site Footer
  {
    ...
    html: `<footer style="background:var(--bs-dark); color:color-mix(in srgb, var(--bs-dark-text) 65%, transparent); padding:60px 0 0;">
  <div class="container">
    <div class="row g-4 mb-4">
      ...
      <div class="col-lg-3 col-md-6">
        ...
        <p style="font-size:0.86rem; line-height:1.7; color:color-mix(in srgb, var(--bs-dark-text) 50%, transparent); margin-bottom:1rem;">Michigan&apos;s Largest Trailer Dealer. Serving communities statewide for over 50 years.</p>
        <div class="d-flex gap-3">
          <a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 45%, transparent); font-size:1.2rem; text-decoration:none;"><i class="bi bi-facebook"></i></a>
          <a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 45%, transparent); font-size:1.2rem; text-decoration:none;"><i class="bi bi-instagram"></i></a>
          <a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 45%, transparent); font-size:1.2rem; text-decoration:none;"><i class="bi bi-youtube"></i></a>
        </div>
      </div>
      <!-- Quick Links -->
      <div class="col-lg-2 col-6">
        ...
        <ul style="list-style:none; padding:0; margin:0;">
          <li class="mb-2"><a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 52%, transparent); text-decoration:none; font-size:0.86rem;">Home</a></li>
          <li class="mb-2"><a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 52%, transparent); text-decoration:none; font-size:0.86rem;">All Inventory</a></li>
          <li class="mb-2"><a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 52%, transparent); text-decoration:none; font-size:0.86rem;">Financing</a></li>
          <li class="mb-2"><a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 52%, transparent); text-decoration:none; font-size:0.86rem;">Parts &amp; Service</a></li>
          <li class="mb-2"><a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 52%, transparent); text-decoration:none; font-size:0.86rem;">Contact Us</a></li>
        </ul>
      </div>
      <!-- Trailer Types -->
      <div class="col-lg-2 col-6">
        ...
        <ul style="list-style:none; padding:0; margin:0;">
          <li class="mb-2"><a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 52%, transparent); text-decoration:none; font-size:0.86rem;">Equipment Trailers</a></li>
          <li class="mb-2"><a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 52%, transparent); text-decoration:none; font-size:0.86rem;">Utility Trailers</a></li>
          <li class="mb-2"><a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 52%, transparent); text-decoration:none; font-size:0.86rem;">Cargo &amp; Enclosed</a></li>
          <li class="mb-2"><a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 52%, transparent); text-decoration:none; font-size:0.86rem;">Dump Trailers</a></li>
          <li class="mb-2"><a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 52%, transparent); text-decoration:none; font-size:0.86rem;">Landscape Trailers</a></li>
        </ul>
      </div>
      <!-- Locations -->
        ...
        <div class="row g-2">
          <div class="col-6">
            <div style="font-size:0.82rem; margin-bottom:0.8rem;">
              ...
              <div style="color:color-mix(in srgb, var(--bs-dark-text) 50%, transparent);">(989) 427-2715</div>
            </div>
            <div style="font-size:0.82rem; margin-bottom:0.8rem;">
              <div class="fw-bold text-white" style="font-size:0.86rem; margin-bottom:2px;">Ionia</div>
              <div style="color:color-mix(in srgb, var(--bs-dark-text) 50%, transparent);">(616) 527-1947</div>
            </div>
            <div style="font-size:0.82rem; margin-bottom:0.8rem;">
              <div class="fw-bold text-white" style="font-size:0.86rem; margin-bottom:2px;">New Boston</div>
              <div style="color:color-mix(in srgb, var(--bs-dark-text) 50%, transparent);">(734) 753-4340</div>
            </div>
            <div style="font-size:0.82rem;">
              <div class="fw-bold text-white" style="font-size:0.86rem; margin-bottom:2px;">Wayland</div>
              <div style="color:color-mix(in srgb, var(--bs-dark-text) 50%, transparent);">(269) 792-9550</div>
            </div>
          </div>
          <div class="col-6">
            <div style="font-size:0.82rem; margin-bottom:0.8rem;">
              <div class="fw-bold text-white" style="font-size:0.86rem; margin-bottom:2px;">Grayling</div>
              <div style="color:color-mix(in srgb, var(--bs-dark-text) 50%, transparent);">(989) 348-2888</div>
            </div>
            <div style="font-size:0.82rem; margin-bottom:0.8rem;">
              <div class="fw-bold text-white" style="font-size:0.86rem; margin-bottom:2px;">Monroe</div>
              <div style="color:color-mix(in srgb, var(--bs-dark-text) 50%, transparent);">(734) 242-7575</div>
            </div>
            <div style="font-size:0.82rem;">
              <div class="fw-bold text-white" style="font-size:0.86rem; margin-bottom:2px;">Traverse City</div>
              <div style="color:color-mix(in srgb, var(--bs-dark-text) 50%, transparent);">(231) 941-0580</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- Bottom bar -->
  <div style="border-top:1px solid color-mix(in srgb, var(--bs-dark-text) 10%, transparent); padding:18px 0;">
    <div class="container d-flex flex-wrap justify-content-between align-items-center gap-3">
      <span style="font-size:0.8rem; color:color-mix(in srgb, var(--bs-dark-text) 35%, transparent);">&copy; 2024 USA Trailer Sales. All rights reserved.</span>
      <div class="d-flex gap-4">
        <a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 35%, transparent); text-decoration:none; font-size:0.8rem;">Privacy Policy</a>
        <a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 35%, transparent); text-decoration:none; font-size:0.8rem;">Terms of Use</a>
        <a href="#" style="color:color-mix(in srgb, var(--bs-dark-text) 35%, transparent); text-decoration:none; font-size:0.8rem;">Sitemap</a>
      </div>
    </div>
  </div>
</footer>`
